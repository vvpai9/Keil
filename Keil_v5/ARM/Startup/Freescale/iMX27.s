...
AIPI1_PSR0_Val  EQU     ((AIPI1_PERI0  :AND: 0x01)        :OR: \
                        ((AIPI1_PERI1  :AND: 0x01) << 1 ) :OR: \
                        ((AIPI1_PERI2  :AND: 0x01) << 2 ) :OR: \
                        ((AIPI1_PERI3  :AND: 0x01) << 3 ) :OR: \
                        ((AIPI1_PERI4  :AND: 0x01) << 4 ) :OR: \
                        ((AIPI1_PERI5  :AND: 0x01) << 5 ) :OR: \
                        ((AIPI1_PERI6  :AND: 0x01) << 6 ) :OR: \
                        ((AIPI1_PERI7  :AND: 0x01) << 7 ) :OR: \
                        ((AIPI1_PERI8  :AND: 0x01) << 8 ) :OR: \
                        ((AIPI1_PERI9  :AND: 0x01) << 9 ) :OR: \
                        ((AIPI1_PERI10 :AND: 0x01) << 10) :OR: \
                        ((AIPI1_PERI11 :AND: 0x01) << 11) :OR: \
                        ((AIPI1_PERI12 :AND: 0x01) << 12) :OR: \
                        ((AIPI1_PERI13 :AND: 0x01) << 13) :OR: \
                        ((AIPI1_PERI14 :AND: 0x01) << 14) :OR: \
                        ((AIPI1_PERI15 :AND: 0x01) << 15) :OR: \
                        ((AIPI1_PERI16 :AND: 0x01) << 16) :OR: \
                        ((AIPI1_PERI17 :AND: 0x01) << 17) :OR: \
                        ((AIPI1_PERI18 :AND: 0x01) << 18) :OR: \
                        ((AIPI1_PERI19 :AND: 0x01) << 19) :OR: \
                        ((AIPI1_PERI20 :AND: 0x01) << 20) :OR: \
                        ((AIPI1_PERI21 :AND: 0x01) << 21) :OR: \
                        ((AIPI1_PERI22 :AND: 0x01) << 22) :OR: \
                        ((AIPI1_PERI23 :AND: 0x01) << 23) :OR: \
                        ( 0x00000000                ) )
AIPI1_PSR1_Val  EQU    (((AIPI1_PERI0  :AND: 0x02) >> 1 ) :OR: \
                        ((AIPI1_PERI1  :AND: 0x02)      ) :OR: \
                        ((AIPI1_PERI2  :AND: 0x02) << 1 ) :OR: \
                        ((AIPI1_PERI3  :AND: 0x02) << 2 ) :OR: \
                        ((AIPI1_PERI4  :AND: 0x02) << 3 ) :OR: \
                        ((AIPI1_PERI5  :AND: 0x02) << 4 ) :OR: \
                        ((AIPI1_PERI6  :AND: 0x02) << 5 ) :OR: \
                        ((AIPI1_PERI7  :AND: 0x02) << 6 ) :OR: \
                        ((AIPI1_PERI8  :AND: 0x02) << 7 ) :OR: \
                        ((AIPI1_PERI9  :AND: 0x02) << 8 ) :OR: \
                        ((AIPI1_PERI10 :AND: 0x02) << 9 ) :OR: \
                        ((AIPI1_PERI11 :AND: 0x02) << 10) :OR: \
                        ((AIPI1_PERI12 :AND: 0x02) << 11) :OR: \
                        ((AIPI1_PERI13 :AND: 0x02) << 12) :OR: \
                        ((AIPI1_PERI14 :AND: 0x02) << 13) :OR: \
                        ((AIPI1_PERI15 :AND: 0x02) << 14) :OR: \
                        ((AIPI1_PERI16 :AND: 0x02) << 15) :OR: \
                        ((AIPI1_PERI17 :AND: 0x02) << 16) :OR: \
                        ((AIPI1_PERI18 :AND: 0x02) << 17) :OR: \
                        ((AIPI1_PERI19 :AND: 0x02) << 18) :OR: \
                        ((AIPI1_PERI20 :AND: 0x02) << 19) :OR: \
                        ((AIPI1_PERI21 :AND: 0x02) << 20) :OR: \
                        ((AIPI1_PERI22 :AND: 0x02) << 21) :OR: \
                        ((AIPI1_PERI23 :AND: 0x02) << 22) :OR: \
                        ( 0xFF000000                ) )
AIPI2_PSR0_Val  EQU     ((AIPI2_PERI0  :AND: 0x01)        :OR: \
                        ((AIPI2_PERI1  :AND: 0x01) << 1 ) :OR: \
                        ((AIPI2_PERI2  :AND: 0x01) << 2 ) :OR: \
                        ((AIPI2_PERI4  :AND: 0x01) << 4 ) :OR: \
                        ((AIPI2_PERI5  :AND: 0x01) << 5 ) :OR: \
                        ((AIPI2_PERI6  :AND: 0x01) << 6 ) :OR: \
                        ((AIPI2_PERI7  :AND: 0x01) << 7 ) :OR: \
                        ((AIPI2_PERI8  :AND: 0x01) << 8 ) :OR: \
                        ( 0x3FDC0000                ) )
AIPI2_PSR1_Val  EQU    (((AIPI2_PERI0  :AND: 0x02) >> 1 ) :OR: \
                        ((AIPI2_PERI1  :AND: 0x02)      ) :OR: \
                        ((AIPI2_PERI2  :AND: 0x02) << 1 ) :OR: \
                        ((AIPI2_PERI4  :AND: 0x02) << 3 ) :OR: \
                        ((AIPI2_PERI5  :AND: 0x02) << 4 ) :OR: \
                        ((AIPI2_PERI6  :AND: 0x02) << 5 ) :OR: \
                        ((AIPI2_PERI7  :AND: 0x02) << 6 ) :OR: \
                        ((AIPI2_PERI8  :AND: 0x02) << 7 ) :OR: \
                        ( 0x3FFFFC08                ) )
...
;     </h>
;   </e>
WEIM_CS0_SETUP  EQU     0
CSCR0U_Val      EQU     0x00001E00
CSCR0L_Val      EQU     0x00000081
CSCR0A_Val      EQU     0x00000000
...
; Enhanced SDRAM Setup ---------------------------------------------------------
                ...
                LDR     R4, =((ESDCTL0_Val :AND: ESDCTL_MSK) :OR: PALL_CMD)
                STR     R4, [R1, #ESDCTL0_OFS]
                STR     R3, [R2, #0]
                LDR     R4, =((ESDCTL0_Val :AND: ESDCTL_MSK) :OR: AREFSH_MODE)
                STR     R4, [R1, #ESDCTL0_OFS]
                STR     R3, [R2, #0]
                STR     R3, [R2, #0]
                STR     R3, [R2, #0]
                ...
                STR     R3, [R2, #0]
                STR     R3, [R2, #0]
                LDR     R4, =((ESDCTL0_Val :AND: ESDCTL_MSK) :OR: MODE_CMD)
                STR     R4, [R1, #ESDCTL0_OFS]
                LDR     R4, =(CSD0_BASE :OR: 0x00000033)
                MOV     R5, #0xDA
                STRB    R5, [R4, #0]
                LDR     R4, =(CSD0_BASE :OR: 0x01000000)
                MOV     R5, #0xFF
                STRB    R5, [R4, #0]
                LDR     R4, =ESDCTL0_Val
                STR     R4, [R1, #ESDCTL0_OFS]
