...
AIPI1_PSR0_Val  EQU     ((AIPI1_PERI0  & 0x01)        :OR: \
                        ((AIPI1_PERI1  & 0x01) << 1 ) :OR: \
                        ((AIPI1_PERI2  & 0x01) << 2 ) :OR: \
                        ((AIPI1_PERI3  & 0x01) << 3 ) :OR: \
                        ((AIPI1_PERI4  & 0x01) << 4 ) :OR: \
                        ((AIPI1_PERI5  & 0x01) << 5 ) :OR: \
                        ((AIPI1_PERI6  & 0x01) << 6 ) :OR: \
                        ((AIPI1_PERI7  & 0x01) << 7 ) :OR: \
                        ((AIPI1_PERI8  & 0x01) << 8 ) :OR: \
                        ((AIPI1_PERI9  & 0x01) << 9 ) :OR: \
                        ((AIPI1_PERI10 & 0x01) << 10) :OR: \
                        ((AIPI1_PERI11 & 0x01) << 11) :OR: \
                        ((AIPI1_PERI12 & 0x01) << 12) :OR: \
                        ((AIPI1_PERI13 & 0x01) << 13) :OR: \
                        ((AIPI1_PERI14 & 0x01) << 14) :OR: \
                        ((AIPI1_PERI15 & 0x01) << 15) :OR: \
                        ((AIPI1_PERI16 & 0x01) << 16) :OR: \
                        ((AIPI1_PERI17 & 0x01) << 17) :OR: \
                        ((AIPI1_PERI18 & 0x01) << 18) :OR: \
                        ((AIPI1_PERI19 & 0x01) << 19) :OR: \
                        ((AIPI1_PERI20 & 0x01) << 20) :OR: \
                        ((AIPI1_PERI21 & 0x01) << 21) :OR: \
                        ((AIPI1_PERI22 & 0x01) << 22) :OR: \
                        ((AIPI1_PERI23 & 0x01) << 23) :OR: \
                        ( 0x00000000                ) )
AIPI1_PSR1_Val  EQU    (((AIPI1_PERI0  & 0x02) >> 1 ) :OR: \
                        ((AIPI1_PERI1  & 0x02)      ) :OR: \
                        ((AIPI1_PERI2  & 0x02) << 1 ) :OR: \
                        ((AIPI1_PERI3  & 0x02) << 2 ) :OR: \
                        ((AIPI1_PERI4  & 0x02) << 3 ) :OR: \
                        ((AIPI1_PERI5  & 0x02) << 4 ) :OR: \
                        ((AIPI1_PERI6  & 0x02) << 5 ) :OR: \
                        ((AIPI1_PERI7  & 0x02) << 6 ) :OR: \
                        ((AIPI1_PERI8  & 0x02) << 7 ) :OR: \
                        ((AIPI1_PERI9  & 0x02) << 8 ) :OR: \
                        ((AIPI1_PERI10 & 0x02) << 9 ) :OR: \
                        ((AIPI1_PERI11 & 0x02) << 10) :OR: \
                        ((AIPI1_PERI12 & 0x02) << 11) :OR: \
                        ((AIPI1_PERI13 & 0x02) << 12) :OR: \
                        ((AIPI1_PERI14 & 0x02) << 13) :OR: \
                        ((AIPI1_PERI15 & 0x02) << 14) :OR: \
                        ((AIPI1_PERI16 & 0x02) << 15) :OR: \
                        ((AIPI1_PERI17 & 0x02) << 16) :OR: \
                        ((AIPI1_PERI18 & 0x02) << 17) :OR: \
                        ((AIPI1_PERI19 & 0x02) << 18) :OR: \
                        ((AIPI1_PERI20 & 0x02) << 19) :OR: \
                        ((AIPI1_PERI21 & 0x02) << 20) :OR: \
                        ((AIPI1_PERI22 & 0x02) << 21) :OR: \
                        ((AIPI1_PERI23 & 0x02) << 22) :OR: \
                        ( 0xFF800000                ) )
AIPI2_PSR0_Val  EQU     ((AIPI2_PERI0  & 0x01)        :OR: \
                        ((AIPI2_PERI1  & 0x01) << 1 ) :OR: \
                        ((AIPI2_PERI2  & 0x01) << 2 ) :OR: \
                        ((AIPI2_PERI4  & 0x01) << 4 ) :OR: \
                        ((AIPI2_PERI5  & 0x01) << 5 ) :OR: \
                        ((AIPI2_PERI6  & 0x01) << 6 ) :OR: \
                        ((AIPI2_PERI7  & 0x01) << 7 ) :OR: \
                        ((AIPI2_PERI8  & 0x01) << 8 ) :OR: \
                        ( 0xFFFC0000                ) )
AIPI2_PSR1_Val  EQU    (((AIPI2_PERI0  & 0x02) >> 1 ) :OR: \
                        ((AIPI2_PERI1  & 0x02)      ) :OR: \
                        ((AIPI2_PERI2  & 0x02) << 1 ) :OR: \
                        ((AIPI2_PERI4  & 0x02) << 3 ) :OR: \
                        ((AIPI2_PERI5  & 0x02) << 4 ) :OR: \
                        ((AIPI2_PERI6  & 0x02) << 5 ) :OR: \
                        ((AIPI2_PERI7  & 0x02) << 6 ) :OR: \
                        ((AIPI2_PERI8  & 0x02) << 7 ) :OR: \
                        ( 0xFFFFFC08                ) )
...
;   </e>
EIM_CS0_SETUP   EQU     1
CS0U_Val        EQU     0x00003E00
CS0L_Val        EQU     0x20000801
...
;   </e>
EIM_CS1_SETUP   EQU     1
CS1U_Val        EQU     0x00003E00
CS1L_Val        EQU     0x20000801
...
;   </h>
NAND_FL_CONFIG1_Val   EQU   0x0008
...
; Clock Setup ------------------------------------------------------------------
                ...
                IF      (CSCR_Val:AND:(MCU_SEL_BIT:OR:SP_SEL_BIT)) != 0
...
; SDRAM Setup ------------------------------------------------------------------
                ...
                ORR     R4, R4, R5
                STR     R4, [R0, #FMCR_OFS]
                LDR     R4, =((SDCTL0_Val & SDCTL_MSK) :OR: PALL_CMD)
                STR     R4, [R1, #SDCTL0_OFS]
                LDR     R4, =(CSD0_BASE :OR: (1 << 21))
                STR     R8, [R4, #0]
                LDR     R4, =((SDCTL0_Val & SDCTL_MSK) :OR: AREFSH_MODE)
                STR     R4, [R1, #SDCTL0_OFS]
                STR     R8, [R2, #0]
                STR     R8, [R2, #0]
                STR     R8, [R2, #0]
                ...
                STR     R8, [R2, #0]
                STR     R8, [R2, #0]
                LDR     R4, =((SDCTL0_Val & SDCTL_MSK) :OR: MODE_CMD)
                STR     R4, [R1, #SDCTL0_OFS]
                LDR     R4, =(CSD0_BASE :OR: SDRAM0_MODE_Val)
                LDR     R4, [R4, #0]
                LDR     R4, =SDCTL0_Val
                STR     R4, [R1, #SDCTL0_OFS]
