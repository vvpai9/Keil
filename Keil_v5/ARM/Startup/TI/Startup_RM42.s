;/*****************************************************************************/
;/* Startup_RM42.S: Startup file for Texas Instruments RM42 device series     */
;/*****************************************************************************/
...
;  Enter Undefined Instruction Mode and set its Stack Pointer
                MOV     R1, #Mode_UND:OR:I_Bit:OR:F_Bit
                MSR     CPSR_cxsf, R1
                MOV     SP, R0
                MOV     R14, #0x0000
                MSR     SPSR_cxsf, R1
...
;  Enter Abort Mode and set its Stack Pointer
                MOV     R1, #Mode_ABT:OR:I_Bit:OR:F_Bit
                MSR     CPSR_cxsf, R1
                MOV     SP, R0
                MOV     R14, #0x0000
                MSR     SPSR_cxsf, R1
...
;  Enter FIQ Mode and set its Stack Pointer
                MOV     R1, #Mode_FIQ:OR:I_Bit:OR:F_Bit
                MSR     CPSR_cxsf, R1
                MOV     SP, R0
                MOV     R8,  #0x0000
                MOV     R9,  #0x0000
...
;  Enter IRQ Mode and set its Stack Pointer
                MOV     R1, #Mode_IRQ:OR:I_Bit:OR:F_Bit
                MSR     CPSR_cxsf, R1
                MOV     SP, R0
                MOV     R14, #0x0000
                MSR     SPSR_cxsf, R1
