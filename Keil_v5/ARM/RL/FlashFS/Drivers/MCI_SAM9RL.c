 ...
 *----------------------------------------------------------------------------
 *      Name:    MCI_SAM9RL.c
 *      Purpose: Multimedia Card Interface Driver for Atmel AT91SAM9RL
 *      Rev.:    V4.20
 *----------------------------------------------------------------------------
...
#define __MCICLK  100000000
#define __CPUCLK  200000000
...
static BOOL Init (void) {
  ...
  pPIOA->PIO_PDR   = 
  pPIOA->PIO_ASR   =
  pPIOA->PIO_PPUER = AT91C_PA0_MC_DA0 | AT91C_PA1_MC_CDA | AT91C_PA2_MC_CK |
                     AT91C_PA3_MC_DA1 | AT91C_PA4_MC_DA2 | AT91C_PA5_MC_DA3;
  pPIOA->PIO_PPUDR = AT91C_PA2_MC_CK;

  /* Enable CD pin. */
  pPIOA->PIO_ODR   = AT91C_PIO_PA15;
...
static BOOL UnInit (void) {
  ...
  /* Disable MCI pins. */
  pPIOA->PIO_PPUDR = AT91C_PA0_MC_DA0 | AT91C_PA1_MC_CDA | AT91C_PA2_MC_CK |
                     AT91C_PA3_MC_DA1 | AT91C_PA4_MC_DA2 | AT91C_PA5_MC_DA3;
...
static U32 CheckMedia (void) {
  ...
  if (!(pPIOA->PIO_PDSR & AT91C_PIO_PA15)) {
    /* Card is inserted (CD=0). */
    stat |= M_INSERTED;
  } 
#if 0
  if (pPIOA->PIO_PDSR & AT91C_PIO_PA16) {
