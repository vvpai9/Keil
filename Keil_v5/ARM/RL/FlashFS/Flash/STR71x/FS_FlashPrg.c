 ...
 *----------------------------------------------------------------------------
 *      Name:    FS_FLASHPRG.C 
 *      Purpose: Flash Programming Functions - STR71x Flash
 *      Rev.:    V4.20
 *----------------------------------------------------------------------------
...
#define FCR0    (*((volatile U32 *) 0x40100000))
#define FCR1    (*((volatile U32 *) 0x40100004))
#define FDR0    (*((volatile U32 *) 0x40100008))
#define FDR1    (*((volatile U32 *) 0x4010000C))
#define FAR     (*((volatile U32 *) 0x40100010))
#define FER     (*((volatile U32 *) 0x40100014))
#define FNVWPAR (*((volatile U32 *) 0x4010DFB0))
#define FNVAPR0 (*((volatile U32 *) 0x4010DFB8))
#define FNVAPR1 (*((volatile U32 *) 0x4010DFBC))
...
static BOOL ProgramPage (U32 adr, U32 sz, U8 *buf) {
  ...
  if (adr < 0x40000000) return (__FALSE);      // Invalid Address
  if (adr > 0x400FFFFF) return (__FALSE);      // Invalid Address
