...
static Buf_Desc Rx_Desc[NUM_RX_BUF] __attribute__ ((at(0x200040)));
static Buf_Desc Tx_Desc[NUM_TX_BUF] __attribute__ ((at(0x200140)));

/* EMAC local buffers must be 8-byte aligned. */
static U64 rx_buf[NUM_RX_BUF][ETH_RX_BUF_SIZE>>3] __attribute__ ((at(0x300000)));
static U64 tx_buf[NUM_TX_BUF][ETH_TX_BUF_SIZE>>3] __attribute__ ((at(0x200148)));
