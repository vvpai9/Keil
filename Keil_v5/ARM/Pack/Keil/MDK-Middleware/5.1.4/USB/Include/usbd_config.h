...
osMutexId  usbd_core_mutex_read_start_id[USBD_DEV_NUM];
osMutexId  usbd_core_mutex_read_id      [USBD_DEV_NUM];
osMutexId  usbd_core_mutex_write_id     [USBD_DEV_NUM];

#ifdef  RTE_USB_Device_0
osMutexDef (usbd0_core_mutex_read_start);
osMutexDef (usbd0_core_mutex_read);
osMutexDef (usbd0_core_mutex_write);
#endif
#ifdef  RTE_USB_Device_1
osMutexDef (usbd1_core_mutex_read_start);
osMutexDef (usbd1_core_mutex_read);
osMutexDef (usbd1_core_mutex_write);
#endif
#ifdef  RTE_USB_Device_2
osMutexDef (usbd2_core_mutex_read_start);
osMutexDef (usbd2_core_mutex_read);
osMutexDef (usbd2_core_mutex_write);
#endif
#ifdef  RTE_USB_Device_3
osMutexDef (usbd3_core_mutex_read_start);
osMutexDef (usbd3_core_mutex_read);
osMutexDef (usbd3_core_mutex_write);
#endif

const osMutexDef_t * const usbd_core_mutex_read_start_def_ptr[USBD_DEV_NUM] = {
#ifdef  RTE_USB_Device_0
        osMutex(usbd0_core_mutex_read_start)
#endif
#ifdef  RTE_USB_Device_1
      , osMutex(usbd1_core_mutex_read_start)
#endif
#ifdef  RTE_USB_Device_2
      , osMutex(usbd2_core_mutex_read_start)
#endif
#ifdef  RTE_USB_Device_3
      , osMutex(usbd3_core_mutex_read_start)
#endif
};

const osMutexDef_t * const usbd_core_mutex_read_def_ptr[USBD_DEV_NUM] = {
#ifdef  RTE_USB_Device_0
        osMutex(usbd0_core_mutex_read)
#endif
#ifdef  RTE_USB_Device_1
      , osMutex(usbd1_core_mutex_read)
#endif
#ifdef  RTE_USB_Device_2
      , osMutex(usbd2_core_mutex_read)
#endif
#ifdef  RTE_USB_Device_3
      , osMutex(usbd3_core_mutex_read)
#endif
};

const osMutexDef_t * const usbd_core_mutex_write_def_ptr[USBD_DEV_NUM] = {
#ifdef  RTE_USB_Device_0
        osMutex(usbd0_core_mutex_write)
#endif
#ifdef  RTE_USB_Device_1
      , osMutex(usbd1_core_mutex_write)
#endif
#ifdef  RTE_USB_Device_2
      , osMutex(usbd2_core_mutex_write)
#endif
#ifdef  RTE_USB_Device_3
      , osMutex(usbd3_core_mutex_write)
#endif
};
...
#ifdef  RTE_USB_Device_ADC_0
int16_t             usbd_adc0_data_buf [8*USBD_ADC0_CFG_PACKET_COUNT*USBD_ADC0_CFG_PACKET_SIZE];
#endif

#ifdef  RTE_USB_Device_ADC_1
int16_t             usbd_adc1_data_buf [8*USBD_ADC1_CFG_PACKET_COUNT*USBD_ADC1_CFG_PACKET_SIZE];
#endif

#ifdef  RTE_USB_Device_ADC_2
int16_t             usbd_adc2_data_buf [8*USBD_ADC2_CFG_PACKET_COUNT*USBD_ADC2_CFG_PACKET_SIZE];
#endif

#ifdef  RTE_USB_Device_ADC_3
int16_t             usbd_adc3_data_buf [8*USBD_ADC3_CFG_PACKET_COUNT*USBD_ADC3_CFG_PACKET_SIZE];
#endif

const   uint8_t     usbd_adc_num  =     USBD_ADC_NUM;
usbd_adc_data_t     usbd_adc_data      [USBD_ADC_NUM];
usbd_adc_t          usbd_adc           [USBD_ADC_NUM] = { 
                                      ...
                                      { 
                                       ...
                                       &usbd_adc_data[0], 
                                        ...
                                        USBD_ADC0_TSAM_FREQ, 
                                        USBD_ADC0_CFG_PACKET_SIZE, 
                                        USBD_ADC0_CFG_PACKET_COUNT, 
                                       (8*USBD_ADC0_CFG_PACKET_COUNT*USBD_ADC0_CFG_PACKET_SIZE), 
                                      } 
#endif
#ifdef  RTE_USB_Device_ADC_1
                                    , { 
                                       ...
                                       &usbd_adc_data[1], 
                                        ...
                                        USBD_ADC1_TSAM_FREQ, 
                                        USBD_ADC1_CFG_PACKET_SIZE, 
                                        USBD_ADC1_CFG_PACKET_COUNT, 
                                       (8*USBD_ADC1_CFG_PACKET_COUNT*USBD_ADC1_CFG_PACKET_SIZE), 
                                      } 
#endif
#ifdef  RTE_USB_Device_ADC_2
                                    , { 
                                       ...
                                       &usbd_adc_data[2], 
                                        ...
                                        USBD_ADC2_TSAM_FREQ, 
                                        USBD_ADC2_CFG_PACKET_SIZE, 
                                        USBD_ADC2_CFG_PACKET_COUNT, 
                                       (8*USBD_ADC2_CFG_PACKET_COUNT*USBD_ADC2_CFG_PACKET_SIZE), 
                                      } 
#endif
#ifdef  RTE_USB_Device_ADC_3
                                    , { 
                                       ...
                                       &usbd_adc_data[3], 
                                        ...
                                        USBD_ADC3_TSAM_FREQ, 
                                        USBD_ADC3_CFG_PACKET_SIZE, 
                                        USBD_ADC3_CFG_PACKET_COUNT, 
                                       (8*USBD_ADC3_CFG_PACKET_COUNT*USBD_ADC3_CFG_PACKET_SIZE), 
                                      } 
#endif
};
...
#ifdef  RTE_USB_Device_CDC_0
extern  void USBD_CDC0_Thread           (void const *arg);
#ifndef USBD_CDC0_THREAD_STACK_SIZE
#define USBD_CDC0_THREAD_STACK_SIZE     0
#endif
#ifndef USBD_CDC0_THREAD_PRIORITY
#define USBD_CDC0_THREAD_PRIORITY       osPriorityAboveNormal
#endif
osThreadDef (USBD_CDC0_Thread, USBD_CDC0_THREAD_PRIORITY, 1, USBD_CDC0_THREAD_STACK_SIZE);
#endif
#ifdef  RTE_USB_Device_CDC_1
extern  void USBD_CDC1_Thread          (void const *arg);
#ifndef USBD_CDC1_THREAD_STACK_SIZE
#define USBD_CDC1_THREAD_STACK_SIZE     0
#endif
#ifndef USBD_CDC1_THREAD_PRIORITY
#define USBD_CDC1_THREAD_PRIORITY       osPriorityAboveNormal
#endif
osThreadDef (USBD_CDC1_Thread, USBD_CDC1_THREAD_PRIORITY, 1, USBD_CDC1_THREAD_STACK_SIZE);
#endif
#ifdef  RTE_USB_Device_CDC_2
extern  void USBD_CDC2_Thread          (void const *arg);
#ifndef USBD_CDC2_THREAD_STACK_SIZE
#define USBD_CDC2_THREAD_STACK_SIZE     0
#endif
#ifndef USBD_CDC2_THREAD_PRIORITY
#define USBD_CDC2_THREAD_PRIORITY       osPriorityAboveNormal
#endif
osThreadDef (USBD_CDC2_Thread, USBD_CDC2_THREAD_PRIORITY, 1, USBD_CDC2_THREAD_STACK_SIZE);
#endif
#ifdef  RTE_USB_Device_CDC_3
extern  void USBD_CDC3_Thread          (void const *arg);
#ifndef USBD_CDC3_THREAD_STACK_SIZE
#define USBD_CDC3_THREAD_STACK_SIZE     0
#endif
#ifndef USBD_CDC3_THREAD_PRIORITY
#define USBD_CDC3_THREAD_PRIORITY       osPriorityAboveNormal
#endif
osThreadDef (USBD_CDC3_Thread, USBD_CDC3_THREAD_PRIORITY, 1, USBD_CDC3_THREAD_STACK_SIZE);
#endif

osThreadId          usbd_cdc_thread_id[USBD_CDC_NUM];
const osThreadDef_t * const usbd_cdc_thread_def_ptr[USBD_CDC_NUM] = {
#ifdef  RTE_USB_Device_CDC_0
        osThread(USBD_CDC0_Thread)
#endif
#ifdef  RTE_USB_Device_CDC_1
      , osThread(USBD_CDC1_Thread)
#endif
#ifdef  RTE_USB_Device_CDC_2
      , osThread(USBD_CDC2_Thread)
#endif
#ifdef  RTE_USB_Device_CDC_3
      , osThread(USBD_CDC3_Thread)
#endif
};
...
extern  void    USBD_SignalDeviceEvent   (int8_t device, ARM_USBD_EVENT event);
extern  void    USBD_SignalEndpointEvent (int8_t device, uint8_t ep_addr, ARM_USBD_EP_EVENT event);
#ifdef  RTE_USB_Device_0
        void    USBD0_SignalDeviceEvent  (ARM_USBD_EVENT event)                       { USBD_SignalDeviceEvent  (0, event);            }
        void    USBD0_SignalEndpointEvent(uint8_t ep_addr, ARM_USBD_EP_EVENT event)   { USBD_SignalEndpointEvent(0, ep_addr, event);   }
#endif
#ifdef  RTE_USB_Device_1
        void    USBD1_SignalDeviceEvent  (ARM_USBD_EVENT event)                       { USBD_SignalDeviceEvent  (1, event);            }
        void    USBD1_SignalEndpointEvent(uint8_t ep_addr, ARM_USBD_EP_EVENT event)   { USBD_SignalEndpointEvent(1, ep_addr, event);   }
#endif
#ifdef  RTE_USB_Device_2
        void    USBD2_SignalDeviceEvent  (ARM_USBD_EVENT event)                       { USBD_SignalDeviceEvent  (2, event);            }
        void    USBD2_SignalEndpointEvent(uint8_t ep_addr, ARM_USBD_EP_EVENT event)   { USBD_SignalEndpointEvent(2, ep_addr, event);   }
#endif
#ifdef  RTE_USB_Device_3
        void    USBD3_SignalDeviceEvent  (ARM_USBD_EVENT event)                       { USBD_SignalDeviceEvent  (3, event);            }
        void    USBD3_SignalEndpointEvent(uint8_t ep_addr, ARM_USBD_EP_EVENT event)   { USBD_SignalEndpointEvent(3, ep_addr, event);   }
#endif
...
ARM_DRV_VERSION       usbd_drv_version [USBD_DEV_NUM] = { 0 };
...
__weak  void      USBD_CustomClass0_Endpoint1_Event            (ARM_USBD_EP_EVENT event) { osSignalWait(0, osWaitForever); };
__weak  void      USBD_CustomClass0_Endpoint2_Event            (ARM_USBD_EP_EVENT event) { osSignalWait(0, osWaitForever); };
__weak  void      USBD_CustomClass0_Endpoint3_Event            (ARM_USBD_EP_EVENT event) { osSignalWait(0, osWaitForever); };
__weak  void      USBD_CustomClass0_Endpoint4_Event            (ARM_USBD_EP_EVENT event) { osSignalWait(0, osWaitForever); };
__weak  void      USBD_CustomClass0_Endpoint5_Event            (ARM_USBD_EP_EVENT event) { osSignalWait(0, osWaitForever); };
__weak  void      USBD_CustomClass0_Endpoint6_Event            (ARM_USBD_EP_EVENT event) { osSignalWait(0, osWaitForever); };
__weak  void      USBD_CustomClass0_Endpoint7_Event            (ARM_USBD_EP_EVENT event) { osSignalWait(0, osWaitForever); };
__weak  void      USBD_CustomClass0_Endpoint8_Event            (ARM_USBD_EP_EVENT event) { osSignalWait(0, osWaitForever); };
__weak  void      USBD_CustomClass0_Endpoint9_Event            (ARM_USBD_EP_EVENT event) { osSignalWait(0, osWaitForever); };
__weak  void      USBD_CustomClass0_Endpoint10_Event           (ARM_USBD_EP_EVENT event) { osSignalWait(0, osWaitForever); };
__weak  void      USBD_CustomClass0_Endpoint11_Event           (ARM_USBD_EP_EVENT event) { osSignalWait(0, osWaitForever); };
__weak  void      USBD_CustomClass0_Endpoint12_Event           (ARM_USBD_EP_EVENT event) { osSignalWait(0, osWaitForever); };
__weak  void      USBD_CustomClass0_Endpoint13_Event           (ARM_USBD_EP_EVENT event) { osSignalWait(0, osWaitForever); };
__weak  void      USBD_CustomClass0_Endpoint14_Event           (ARM_USBD_EP_EVENT event) { osSignalWait(0, osWaitForever); };
__weak  void      USBD_CustomClass0_Endpoint15_Event           (ARM_USBD_EP_EVENT event) { osSignalWait(0, osWaitForever); };

__weak  void      USBD_CustomClass1_Endpoint1_Event            (ARM_USBD_EP_EVENT event) { osSignalWait(0, osWaitForever); };
__weak  void      USBD_CustomClass1_Endpoint2_Event            (ARM_USBD_EP_EVENT event) { osSignalWait(0, osWaitForever); };
__weak  void      USBD_CustomClass1_Endpoint3_Event            (ARM_USBD_EP_EVENT event) { osSignalWait(0, osWaitForever); };
__weak  void      USBD_CustomClass1_Endpoint4_Event            (ARM_USBD_EP_EVENT event) { osSignalWait(0, osWaitForever); };
__weak  void      USBD_CustomClass1_Endpoint5_Event            (ARM_USBD_EP_EVENT event) { osSignalWait(0, osWaitForever); };
__weak  void      USBD_CustomClass1_Endpoint6_Event            (ARM_USBD_EP_EVENT event) { osSignalWait(0, osWaitForever); };
__weak  void      USBD_CustomClass1_Endpoint7_Event            (ARM_USBD_EP_EVENT event) { osSignalWait(0, osWaitForever); };
__weak  void      USBD_CustomClass1_Endpoint8_Event            (ARM_USBD_EP_EVENT event) { osSignalWait(0, osWaitForever); };
__weak  void      USBD_CustomClass1_Endpoint9_Event            (ARM_USBD_EP_EVENT event) { osSignalWait(0, osWaitForever); };
__weak  void      USBD_CustomClass1_Endpoint10_Event           (ARM_USBD_EP_EVENT event) { osSignalWait(0, osWaitForever); };
__weak  void      USBD_CustomClass1_Endpoint11_Event           (ARM_USBD_EP_EVENT event) { osSignalWait(0, osWaitForever); };
__weak  void      USBD_CustomClass1_Endpoint12_Event           (ARM_USBD_EP_EVENT event) { osSignalWait(0, osWaitForever); };
__weak  void      USBD_CustomClass1_Endpoint13_Event           (ARM_USBD_EP_EVENT event) { osSignalWait(0, osWaitForever); };
__weak  void      USBD_CustomClass1_Endpoint14_Event           (ARM_USBD_EP_EVENT event) { osSignalWait(0, osWaitForever); };
__weak  void      USBD_CustomClass1_Endpoint15_Event           (ARM_USBD_EP_EVENT event) { osSignalWait(0, osWaitForever); };

__weak  void      USBD_CustomClass2_Endpoint1_Event            (ARM_USBD_EP_EVENT event) { osSignalWait(0, osWaitForever); };
__weak  void      USBD_CustomClass2_Endpoint2_Event            (ARM_USBD_EP_EVENT event) { osSignalWait(0, osWaitForever); };
__weak  void      USBD_CustomClass2_Endpoint3_Event            (ARM_USBD_EP_EVENT event) { osSignalWait(0, osWaitForever); };
__weak  void      USBD_CustomClass2_Endpoint4_Event            (ARM_USBD_EP_EVENT event) { osSignalWait(0, osWaitForever); };
__weak  void      USBD_CustomClass2_Endpoint5_Event            (ARM_USBD_EP_EVENT event) { osSignalWait(0, osWaitForever); };
__weak  void      USBD_CustomClass2_Endpoint6_Event            (ARM_USBD_EP_EVENT event) { osSignalWait(0, osWaitForever); };
__weak  void      USBD_CustomClass2_Endpoint7_Event            (ARM_USBD_EP_EVENT event) { osSignalWait(0, osWaitForever); };
__weak  void      USBD_CustomClass2_Endpoint8_Event            (ARM_USBD_EP_EVENT event) { osSignalWait(0, osWaitForever); };
__weak  void      USBD_CustomClass2_Endpoint9_Event            (ARM_USBD_EP_EVENT event) { osSignalWait(0, osWaitForever); };
__weak  void      USBD_CustomClass2_Endpoint10_Event           (ARM_USBD_EP_EVENT event) { osSignalWait(0, osWaitForever); };
__weak  void      USBD_CustomClass2_Endpoint11_Event           (ARM_USBD_EP_EVENT event) { osSignalWait(0, osWaitForever); };
__weak  void      USBD_CustomClass2_Endpoint12_Event           (ARM_USBD_EP_EVENT event) { osSignalWait(0, osWaitForever); };
__weak  void      USBD_CustomClass2_Endpoint13_Event           (ARM_USBD_EP_EVENT event) { osSignalWait(0, osWaitForever); };
__weak  void      USBD_CustomClass2_Endpoint14_Event           (ARM_USBD_EP_EVENT event) { osSignalWait(0, osWaitForever); };
__weak  void      USBD_CustomClass2_Endpoint15_Event           (ARM_USBD_EP_EVENT event) { osSignalWait(0, osWaitForever); };

__weak  void      USBD_CustomClass3_Endpoint1_Event            (ARM_USBD_EP_EVENT event) { osSignalWait(0, osWaitForever); };
__weak  void      USBD_CustomClass3_Endpoint2_Event            (ARM_USBD_EP_EVENT event) { osSignalWait(0, osWaitForever); };
__weak  void      USBD_CustomClass3_Endpoint3_Event            (ARM_USBD_EP_EVENT event) { osSignalWait(0, osWaitForever); };
__weak  void      USBD_CustomClass3_Endpoint4_Event            (ARM_USBD_EP_EVENT event) { osSignalWait(0, osWaitForever); };
__weak  void      USBD_CustomClass3_Endpoint5_Event            (ARM_USBD_EP_EVENT event) { osSignalWait(0, osWaitForever); };
__weak  void      USBD_CustomClass3_Endpoint6_Event            (ARM_USBD_EP_EVENT event) { osSignalWait(0, osWaitForever); };
__weak  void      USBD_CustomClass3_Endpoint7_Event            (ARM_USBD_EP_EVENT event) { osSignalWait(0, osWaitForever); };
__weak  void      USBD_CustomClass3_Endpoint8_Event            (ARM_USBD_EP_EVENT event) { osSignalWait(0, osWaitForever); };
__weak  void      USBD_CustomClass3_Endpoint9_Event            (ARM_USBD_EP_EVENT event) { osSignalWait(0, osWaitForever); };
__weak  void      USBD_CustomClass3_Endpoint10_Event           (ARM_USBD_EP_EVENT event) { osSignalWait(0, osWaitForever); };
__weak  void      USBD_CustomClass3_Endpoint11_Event           (ARM_USBD_EP_EVENT event) { osSignalWait(0, osWaitForever); };
__weak  void      USBD_CustomClass3_Endpoint12_Event           (ARM_USBD_EP_EVENT event) { osSignalWait(0, osWaitForever); };
__weak  void      USBD_CustomClass3_Endpoint13_Event           (ARM_USBD_EP_EVENT event) { osSignalWait(0, osWaitForever); };
__weak  void      USBD_CustomClass3_Endpoint14_Event           (ARM_USBD_EP_EVENT event) { osSignalWait(0, osWaitForever); };
__weak  void      USBD_CustomClass3_Endpoint15_Event           (ARM_USBD_EP_EVENT event) { osSignalWait(0, osWaitForever); };
...
#define CUSTOM_CLASS_EP_EVENT_FUNC(n)  
      ...
      , USBD_CustomClass3_Uninitialize 
        ...
        void (* const USBD_Endpoint_Event[USBD_CUSTOM_CLASS_NUM * USBD_EP_NUM]) (ARM_USBD_EP_EVENT event) = 
      { 
...
#if    (USBD_ADC_NUM == 0)
        bool      USBD_EndPoint0_Setup_ADC_ReqToIF (int8_t device) { return false; }
        bool      USBD_EndPoint0_Setup_ADC_ReqToEP (int8_t device) { return false; }
        bool      USBD_EndPoint0_Out_ADC_ReqToIF   (int8_t device) { return false; }
        bool      USBD_EndPoint0_Out_ADC_ReqToEP   (int8_t device) { return false; }
#else
extern  bool      USBD_EndPoint0_Setup_ADC_ReqToIF (int8_t device);
extern  bool      USBD_EndPoint0_Setup_ADC_ReqToEP (int8_t device);
extern  bool      USBD_EndPoint0_Out_ADC_ReqToIF   (int8_t device);
extern  bool      USBD_EndPoint0_Out_ADC_ReqToEP   (int8_t device);
extern  usbStatus USBD_ADC_ClassInitialize         (int8_t instance);
extern  usbStatus USBD_ADC_ClassUninitialize       (int8_t instance);
extern  void      USBD_ADC_EventReset              (int8_t instance);
extern  void      USBD_ADC_EventEndpointStart      (int8_t instance, uint8_t ep_addr);
...
#endif
__weak  void      USBD_CDC_ACM_DataReceived        (int8_t instance, int32_t len) { };
...
__weak usbStatus USBD_ClassInitialize (int8_t device) {
  ...
  for (instance = 0; instance < usbd_adc_num; instance++) { 
    if (usbd_adc_ptr[instance]->data_ptr != NULL) { 
...
__weak void USBD_EventConnect                    (int8_t device) {};
__weak void USBD_EventDisconnect                 (int8_t device) {};
...
__weak void USBD_EventRemoteWakeup               (int8_t device) {};
...
__weak void USBD_EventEndpointStart              (int8_t device, uint8_t ep_addr) {
  ...
  for (instance = 0; instance < usbd_adc_num; instance++) { 
    if (usbd_adc_ptr[instance]->data_ptr != NULL) { 
      if (usbd_adc_ptr[instance]->dev_num == device) { 
        if (((usbd_hid_ptr[instance]->ep_iso_out       ) == ep_addr)) { 
