...
void USBD_MSC%Instance%_Initialize (void) {
  ...
  msc_data_ptr = usbd_msc_ptr[%Instance%]->data_ptr;
...
bool USBD_MSC%Instance%_Read (uint32_t lba, uint16_t cnt, uint8_t *buf) {
...
bool USBD_MSC%Instance%_Write (uint32_t lba, uint16_t cnt, const uint8_t *buf) {
