...
//         <o1.14> Port 15
//       </h>
#define USBH%Instance%_HC_OHCI_PORT_MASK         0x00000001
...
#define USBH%Instance%_HC_OHCI_ENDPOINT_NUM      3
...
#define USBH%Instance%_HC_MEM_POOL_SIZE          524
...
#define USBH%Instance%_CORE_THREAD_PRIORITY      osPriorityNormal
