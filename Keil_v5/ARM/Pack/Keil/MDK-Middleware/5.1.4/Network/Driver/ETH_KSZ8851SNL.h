...
#define TX_FRAME_HEADER_TXIC (1 << 15)  /* Transmit Interrupt on Completion */

#define SPI_CMD_REGISTER_READ   0x00
#define SPI_CMD_REGISTER_WRITE  0x40
#define SPI_CMD_RXQ_FIFO_READ   0x80
#define SPI_CMD_TXQ_FIFO_WRITE  0xC0
...
/* Global Reset Register (GRR) Bitmask Definitions */
#define REG_GRR_GSR          (1 <<  0)  /* Global Soft Reset */
#define REG_GRR_QMSR         (1 <<  1)  /* QMU Module Soft Reset */

/* Transmit Control Register (TXCR) Bitmask Definitions */
...
/* Receive Control Register 1 (RXCR1) Bitmask Definitions */
...
/* Receive Control Register 2 (RXCR2) Bitmask Definitions */
...
/* TXQ Command Register (TXQCR) Bitmask Definitions */
...
/* RXQ Command Register (RXQCR) Bitmask Definitions */
...
/* TX Frame Data Pointer Register (TXFDPR) Bitmask Definitions */
#define REG_TXFDPR_TXFPAI    (1 << 14)  /* TX Frame Data Pointer Auto Increment */

/* Receive Frame Header Status Register (RXFHSR) Bitmask Definitions */
...
/* RX Frame Data Pointer Register (RXFDPR) Bitmask Definitions */
#define REG_RXFDPR_RXFPAI    (1 << 14)  /* RX Frame Pointer Auto Increment */

/* Interrupt Enable Register (IER) Bitmask Definitions */
...
/* Interrupt Status Register (ISR) Bitmask Definitions */
...
/* PHY 1 MII-Register Basic Control Register (P1MBCR) Bitmask Definitions */
...
/* Port 1 Control Register (P1CR) Bitmask Definitions */
...
/* Port 1 Status Register (P1SR) Bitmask Definitions */
