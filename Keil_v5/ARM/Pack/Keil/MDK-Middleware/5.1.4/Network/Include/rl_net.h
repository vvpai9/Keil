...
#define IP_ADDR_LEN             4       ///< IP Address Length in bytes
...
#define BSD_ERROR_LOCKED        (-7)    ///< Socket is locked in RTX environment
...
///                              - MSG_PEEK       = peek at incoming data,
///                              - 0              = for none.
/// \param[in]     from          structure containing remote IP address and port.
/// \param[in]     fromlen       length of \ref SOCKADDR structure.
/// \return      status information:
///              - Number of bytes received or
///              - BSD_ERROR_SOCKET     = Socket invalid or in invalid state.
///              - BSD_ERROR_CLOSED     = Remote node has closed the connection.
...
/// \brief Delete a file or directory in FTP server.
/// \param[in]     fname         name of the file or directory to delete.
/// \return
///              - true        = File or directory successfully deleted.
///              - false       = Failed to delete a file or directory.
