...
static void _cbColor(WM_MESSAGE * pMsg) {
  ...
  case WM_PAINT:
    ...
    Rect.x1--;
    Rect.y1--;
    (U32 *)WM_GetUserData(pMsg->hWin, &pColor, sizeof(U32 *));
    GUI_SetColor(*pColor);
    GUI_FillRectEx(&Rect);
    break;
  default:
  ...
  case WM_NOTIFY_PARENT:
    ...
    case ID_BUTTON_4: // Notifications sent by 'Button 4'
      ...
      case WM_NOTIFICATION_RELEASED:
        ...
        WM_InvalidateWindow(WM_HBKWIN);
        WM_MakeModal(0);
        hWin = CHOOSECOLOR_Create(WM_HBKWIN, 10, 10, xSize - 20, ySize - 20, _aColors, GUI_COUNTOF(_aColors), 16, _Index, "Choose Color", 0);
        break;
      }
      break;
  ...
  do {
    ...
    if (State) {
      ...
      case 6:
        ...
        break;
      case 7:
        Key = (i0 ^= 1) ? GUI_KEY_DOWN : GUI_KEY_UP;
        _SendKey(Key, 4);
        break;
      case 8:
...
void MainTask(void) {
  int xSize;
  WM_HWIN hWin, hButton0, hButton1;
