/******************************************************************************
     ...
     File   Name  :  ML67Q5260.h
     Revision     :  1.00
     Date         :  2010/04/16      First version
...
#define RMPCON_RMPM_AHBROM  (0x0000000B)  /* AHBROM */
#define RMPCON_RMPM_B_FLASH (0x0000000E)  /* Build in Flash memory */
...
#define PINSTAT     (CTL_BAS+(0x04))  /* PIN status register (R,32,0xXXXXXXXX) */
...
#define EXINTLVCNT	(CTL_BAS+(0x80))

/* bit field of EXINTLVCNT register */
#define EXINTLVCNT_EIR0LV	(0x00000001)	/* External interrupt 0(PB08)*/
#define EXINTLVCNT_EIR1LV	(0x00000002)	/* External interrupt 1(PB09)*/
#define EXINTLVCNT_VBUS		(0x00000008)	/* PA11 */
...
#define PECLKCNT_CKE_TIF		(0x040)
#define PECLKCNT_CKE_FPSP_ST	(0x100)
#define PECLKCNT_CKE_FPSP_CT	(0x200)
#define PECLKCNT_CKE_FPSP_MA	(0x400)

#define PECLKCNT_CKE_CLKOUT	(0x20)
#define PECLKCNT_CKE_FPSP	(0x10)
#define PECLKCNT_CKE_USB	(0x08)
#define PECLKCNT_CKE_SPI	(0x04)
#define PECLKCNT_CKE_SIMIF	(0x02)
#define PECLKCNT_CKE_SSIO	(0x01)
...
#define PERSTCNT_RST_SPI0	(0x100)
#define PERSTCNT_RST_SPI1	(0x200)

/* bit field of CLKSTPCNT register */
#define CLKSTPCNT_OSCEN		(0x00000001)
#define CLKSTPCNT_CLKOUTEN	(0x00000100)
#define CLKSTPCNT_PLLEN		(0x00010000)
...
#define EXIDM_IRQ30   (0x0000C000)        /* IRQ30 */
...
/* bit field of IM0n,IM1n register (n=A-C)*/
#define IM0_IMR0	(0x00000007)
#define IM0_IMR1	(0x00000070)
#define IM0_IMR2	(0x00000700)
#define IM0_IMR3	(0x00007000)
#define IM0_IMR4	(0x00070000)
#define IM0_IMR5	(0x00700000)
#define IM0_IMR6	(0x07000000)
#define IM0_IMR7	(0x70000000)
#define IM1_IMR8	(0x00000007)
#define IM1_IMR9	(0x00000070)
#define IM1_IMR10	(0x00000700)
#define IM1_IMR11	(0x00007000)
#define IM1_IMR12	(0x00070000)
#define IM1_IMR13	(0x00700000)
#define IM1_IMR14	(0x07000000)
#define IM1_IMR15	(0x70000000)

#define IMR_INT_NEG_EDGE	(0x00000000)	/* interrupt at the falling edge */
#define IMR_INT_POS_EDGE	(0x11111111)	/* interrupt at the rising edge */
#define IMR_INT_LOW_LEVEL	(0x22222222)	/* interrupt at the input of LOW Level */
#define IMR_INT_HIGH_LEVEL	(0x33333333)	/* interrupt at the input of HIGH Level */
#define IMR_INT_EDGE		(0x44444444)	/* interrupt at both edges(rising/falling edge) */
...
#define SSIOCON_TCK0    (0x00)          /* selected  32 MHz for sync clock(base 32MHz) */
#define SSIOCON_TCK1    (0x01)          /* selected  16 MHz for sync clock(base 32MHz) */
#define SSIOCON_TCK2    (0x02)          /* selected   8 MHz for sync clock(base 32MHz) */
#define SSIOCON_TCK3    (0x03)          /* selected   2 MHz for sync clock(base 32MHz) */
#define SSIOCON_TCK4    (0x04)          /* selected   1 MHz for sync clock(base 32MHz) */
#define SSIOCON_TCK5    (0x05)          /* selected 250 kHz for sync clock(base 32MHz) */
...
#define OSCTEST         (UDE_BASE+0xE8)         /* Oscillator test register */
...
/*****************************************************/
#define RND_BASE        0xB7900000              /* base address of Random Number Generator registers */

#define RND				(RND_BASE+0x00)         /* Random number generation register        */
#define RNDEN			(RND_BASE+0x04)         /* Random number generation enable register */

/* bit field of RNDEN register */
#define RNDEN_EN		0x00000001      /* Random Generation circuit enable bit */

/*****************************************************/
/*    WDT registers                                  */
/*****************************************************/
#define WDT_BASE        0xB7E00000              /* base address of WDT registers */

#define WDTCON			(WDT_BASE+0x00)         /* Watchdog timer control register */
...
#define DMAIRQ1		23			/* DMA Channel 1 */
 #define EXTIRQ0	24			/* External INT 0 */
    /* reserved     25  */
    /* reserved     26  */
    /* reserved     27  */
 #define EXTIRQ2	28			/* External INT 2 */
    /* reserved     29  */
 #define EXTIRQ3	30			/* External INT 3 */
    /* reserved     31  */

#ifdef __cplusplus
};      /* End of 'extern "C"' */
#endif
#endif  /* End of ML67Q5260_H */
