// ===============================================																																																																																				
// ADuC7023 HEADER FILE REV 1.7 22nd June 2011																																																																																				
// v.17 RSTKEY0 and RSTKEY1 key pair renamed to RSTKEY1 and RSTKEY2 to match datasheet.																																																																																				
//      PWMCON renamed to PWMCON1 to match datasheet.																																																																																				
//      PLLSTA register is not present. Removed.																																																																																				
//      POWCON duplicated as POWCON0 to match datasheet.																																																																																				
// ===============================================																																																																																				
...
#define          RESETBASE                                  (*(volatile unsigned long      *) 0xFFFF0200)
...
#define          RSTKEY1                                    (*(volatile unsigned long      *) 0xFFFF0248)
#define          RSTCFG                                     (*(volatile unsigned long      *) 0xFFFF024C)
#define          RSTKEY2                                    (*(volatile unsigned long      *) 0xFFFF0250)
...
#define          SYSBASE                                    (*(volatile unsigned long      *) 0xFFFF0400)
...
#define          DACBKEY0                                   (*(volatile unsigned long      *) 0xFFFF0650)
#define          DACBCFG                                    (*(volatile unsigned long      *) 0xFFFF0654)
#define          DACBKEY1                                   (*(volatile unsigned long      *) 0xFFFF0658)
