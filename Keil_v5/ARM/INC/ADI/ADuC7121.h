// ===============================================																																																																																				
// ADuC7121 HEADER FILE REV 1.6 17th January 2013																																																																																				
// ===============================================																																																																																				
...
#define          RSTCFGKEY0                                 (*(volatile unsigned long      *) 0xFFFF0248)
#define          RSTCFG                                     (*(volatile unsigned long      *) 0xFFFF024C)
#define          RSTCFGKEY1                                 (*(volatile unsigned long      *) 0xFFFF0250)
...
#define          DAC2CON                                    (*(volatile unsigned long      *) 0xFFFF05B0)
// DAC2 Data Register
#define          DAC2DAT                                    (*(volatile unsigned long      *) 0xFFFF05B4)
// DAC3 Control Register
#define          DAC3CON                                    (*(volatile unsigned long      *) 0xFFFF05D8)
// DAC3 Data Register
#define          DAC3DAT                                    (*(volatile unsigned long      *) 0xFFFF05DC)

// IDAC Interface Peripheral

#define          IDACBASE                                   (*(volatile unsigned long      *) 0xFFFF0700)
#define          IDAC0CON                                   (*(volatile unsigned long      *) 0xFFFF0700)
#define          IDAC0DAT                                   (*(volatile unsigned long      *) 0xFFFF0704)
#define          IDAC0BW                                    (*(volatile unsigned long      *) 0xFFFF0708)
#define          IDAC1CON                                   (*(volatile unsigned long      *) 0xFFFF070C)
#define          IDAC1DAT                                   (*(volatile unsigned long      *) 0xFFFF0710)
#define          IDAC1BW                                    (*(volatile unsigned long      *) 0xFFFF0714)
#define          IDAC2CON                                   (*(volatile unsigned long      *) 0xFFFF0718)
#define          IDAC2DAT                                   (*(volatile unsigned long      *) 0xFFFF071C)
#define          IDAC2BW                                    (*(volatile unsigned long      *) 0xFFFF0720)
#define          IDAC3CON                                   (*(volatile unsigned long      *) 0xFFFF0724)
#define          IDAC3DAT                                   (*(volatile unsigned long      *) 0xFFFF0728)
#define          IDAC3BW                                    (*(volatile unsigned long      *) 0xFFFF072C)
#define          IDAC4CON                                   (*(volatile unsigned long      *) 0xFFFF0730)
#define          IDAC4DAT                                   (*(volatile unsigned long      *) 0xFFFF0734)
#define          IDAC4BW                                    (*(volatile unsigned long      *) 0xFFFF0738)
#define          TSDCON                                     (*(volatile unsigned long      *) 0xFFFF073C)
#define          IDACSTA                                    (*(volatile unsigned long      *) 0xFFFF0740)
#define          IDAC0PULLDOWN                              (*(volatile unsigned long      *) 0xFFFF0744)
...
#define          I2C0MCTL                                   (*(volatile unsigned long      *) 0xFFFF0880)
...
// Start Byte Register
#define          I2C0SBYTE                                  (*(volatile unsigned long      *) 0xFFFF08A0)
// Serial clock period divisor register
#define          I2C0DIV                                    (*(volatile unsigned long      *) 0xFFFF08A4)
// Slave control register
#define          I2C0SCTL                                   (*(volatile unsigned long      *) 0xFFFF08A8)
...
// Master control register.
#define          I2C1MCTL                                   (*(volatile unsigned long      *) 0xFFFF0900)
// "Master Status, Error, and IRQ register."
...
// Start Byte Register
#define          I2C1SBYTE                                  (*(volatile unsigned long      *) 0xFFFF0920)
// Serial clock period divisor register
#define          I2C1DIV                                    (*(volatile unsigned long      *) 0xFFFF0924)
// Slave control register
#define          I2C1SCTL                                   (*(volatile unsigned long      *) 0xFFFF0928)
// Slave status register
