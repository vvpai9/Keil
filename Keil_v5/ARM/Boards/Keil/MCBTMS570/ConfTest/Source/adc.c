...
void GetSolCurrent (unsigned int * I1, unsigned int * I2, unsigned int * I3, unsigned int * I4)
{
    /** - Setup FiFo size */
    adcREG1->GxINTCR[1] = 4;

    /** - Start Conversion */
    adcREG1->GxSEL[1] = 0x00F0;    // start channel 4, 5, 6, 7

    /** - Read conversion flags */
    while((adcREG1->GxINTFLG[1] & 8U) == 0);
    
    *I1   = adcREG1->GxBUF[1].BUF0;
    *I1  &= 0x00000FFF;
    *I2   = adcREG1->GxBUF[1].BUF0;
    *I2  &= 0x00000FFF;
    *I3   = adcREG1->GxBUF[1].BUF0;
    *I3  &= 0x00000FFF;
    *I4   = adcREG1->GxBUF[1].BUF0;
    *I4  &= 0x00000FFF;
}

void GetSensorInput (unsigned int * Input1, unsigned int * Input2)
{
    /** - Setup FiFo size */
    adcREG1->GxINTCR[1] = 2;

    /** - Start Conversion */
    adcREG1->GxSEL[1] = 0x000C;    // start channel 2 and 3

    /** - Read conversion flags */
    while((adcREG1->GxINTFLG[1] & 8U) == 0);
    
    *Input2  = adcREG1->GxBUF[1].BUF0;
    *Input2 &= 0x00000FFF;
    *Input1  = adcREG1->GxBUF[1].BUF0;
    *Input1 &= 0x00000FFF;
}
