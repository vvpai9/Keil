...
void gioInit(void)
{
    ...
    /** - Port A direction */
    gioPORTA->DIR  = (1 << 0)  /* Bit 0 LED      */
                   | (0 << 1)  /* Bit 1 */
                   | (0 << 2)  /* Bit 2 SDC detect (input) */
                   | (1 << 3)  /* Bit 3 LED      */
                   | (1 << 4)  /* Bit 4 LED      */
                   | (1 << 5)  /* Bit 5 LED      */
                   | (1 << 6)  /* Bit 6 air pump */
    ...
    gioPORTA->PSL  =  0        /* Bit 0 */
                   | (0 << 1)  /* Bit 1 */
                   | (1 << 2)  /* Bit 2 pull-up for SDC detect */
                   | (0 << 3)  /* Bit 3 */
                   | (0 << 4)  /* Bit 4 */
                   | (0 << 5)  /* Bit 5 */
                   | (0 << 6)  /* Bit 6 */
    ...
    gioPORTA->PULDIS  =  0        /* Bit 0 */
                      | (0 << 1)  /* Bit 1 */
                      | (0 << 2)  /* Bit 2 enable pull up/down for SDC detect */
                      | (0 << 3)  /* Bit 3 */
                      | (0 << 4)  /* Bit 4 */
                      | (0 << 5)  /* Bit 5 */
                      | (0 << 6)  /* Bit 6 */
    ...
    gioPORTB->DOUT = (0 << 0)  /* Bit 0 */
                   | (0 << 1)  /* Bit 1 */
                   | (0 << 2)  /* Bit 2 */ // output signal for external watchdog timer
                   | (0 << 3)  /* Bit 3 */ // input signal from switch 1
                   | (0 << 4)  /* Bit 4 */
                   | (0 << 5)  /* Bit 5 */
                   | (0 << 6)  /* Bit 6 */ // input signal from switch 2
                   | (0 << 7); /* Bit 7 */

    /** - Port B direction */
    gioPORTB->DIR  =  0        /* Bit 0 */
                   | (0 << 1)  /* Bit 1 */
                   | (1 << 2)  /* Bit 2 */ // output signal for external watchdog timer
                   | (0 << 3)  /* Bit 3 */ // input signal from switch 1
                   | (0 << 4)  /* Bit 4 */
                   | (0 << 5)  /* Bit 5 */
                   | (0 << 6)  /* Bit 6 */ // input signal from switch 2
