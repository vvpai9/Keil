 ...
 *----------------------------------------------------------------------------
 *      Name:    MCI_LPC24xx.c
 *      Purpose: Multimedia Card Interface Driver for NXP LPC24xx
 *      Rev.:    V4.70
 *----------------------------------------------------------------------------
...
/* Following macro definitions can be used to select the Evaluation Board:
  ...
  _MCB2470_   - MCB2470 used
  _MCB2400_   - MCB2400 used  (default)                                      */
...
static BOOL Init (void) {
  ...
  /* Enable MCI pins. */
#ifdef _MCB2470_  /* MCB2470 */
  /* MCB2470: P1.2  MCICLK,  P1.3 MCICMD,  P1.5  MCIPWR,
              P1.6  MCIDAT0, P1,7 MCIDAT1, P1.11 MCIDAT2, P1.12 MCIDAT3 */
  PINSEL2 &= ~0x03C0FCF0;
  PINSEL2 |=  0x0280A8A0;
#else             /* MCB2400 */
  /* MCB2400: P1.2  MCICLK,  P1.3 MCICMD,  P1.5  MCIPWR,
              P0.22 MCIDAT0, P1,7 MCIDAT1, P1.11 MCIDAT2, P1.12 MCIDAT3 */
  PINSEL1 &= ~0x00003000;
  PINSEL1 |=  0x00002000;
  PINSEL2 &= ~0x03C0CCF0;
  PINSEL2 |=  0x028088A0;
