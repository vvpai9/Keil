 ...
 *----------------------------------------------------------------------------
 *      Name:    usbreg.h
 *      Purpose: Hardware Layer Definitions for ST STR71x
 *----------------------------------------------------------------------------
...
#define USB_BASE_ADDR   0xC0008800  /* USB Registers Base Address */
#define USB_PMA_ADDR    0xC0008000  /* USB Packet Memory Area Address */
