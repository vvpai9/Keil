...
#define red     0x01                  /* I/O Pin:  red    lamp output        */
#define yellow  0x02                  /* I/O Pin:  yellow lamp output        */
#define green   0x04                  /* I/O Pin:  green  lamp output        */
#define stop    0x10                  /* I/O Pin:  stop   lamp output        */
#define walk    0x20                  /* I/O Pin:  walk   lamp output        */
#define key     0x40                  /* I/O Pin:  self-service key input    */
#define SET(o,s) {        \
  if (s==0) GPIO7->DR[(o)<<2] =  0;  \
  else      GPIO7->DR[(o)<<2] = (o); \
};
...
__task void keyread (void) {
  while (1) {                                 /* endless loop                */
    if (GPIO3->DR[key<<2] == 0) {             /* if key pressed              */
