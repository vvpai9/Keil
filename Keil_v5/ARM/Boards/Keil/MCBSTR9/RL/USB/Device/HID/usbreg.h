 ...
 *----------------------------------------------------------------------------
 *      Name:    usbreg.h
 *      Purpose: Hardware Layer Definitions for ST STR91x
 *----------------------------------------------------------------------------
...
#define USB_BASE_ADDR   0x70000800  /* USB Registers Base Address */
#define USB_PMA_ADDR    0x70000000  /* USB Packet Memory Area Address */
