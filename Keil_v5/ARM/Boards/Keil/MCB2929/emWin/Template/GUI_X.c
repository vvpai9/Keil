...
void GUI_X_Init(void) {
  ...
  // Configure Timer 0 to generate periodic IRQ each 1ms
  TMR_CLK_CONF = 0x02000804;
  TIM0_PR  = 0;
  TIM0_MR0 = (96000000/1000) - 1;  // 1ms @ 96MHz
  TIM0_MCR = 1;
  TIM0_INT_SET_ENABLE = 1;
  INT_REQUEST_2 = 0x1C01010F;
  TIM0_TCR = 1;
}
