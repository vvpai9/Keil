 ...
 *----------------------------------------------------------------------------
 * Name:    usbhw.c
 * Purpose: USB Hardware Layer Module for Philips LPC29xx
 * Version: V1.20
 *----------------------------------------------------------------------------
...
void USB_Init (void) {
  ...
  /* Configure USB clock = CGU1 PLL clock / 1 = 48 MHz (max allowed 96 MHz)      */
  USB_CLK_CONF   = (2UL << 24) | (0 << 11) | (0 << 2);
  /* P5.19 D+, P5.18 D- */
  SFSP5_19  = 1;
  SFSP5_18  = 1;
  /* P2.9 UP_LED */
  SFSP2_9   = 1;
  /* P1.24 USB_CONNECT, P1.25 VBUS */
  SFSP1_24  = 0x06;
  SFSP1_25  = 0x06;
  ...
  INT_REQUEST_47    = (1 << 28) |        /* Enable setting of priority level   */
