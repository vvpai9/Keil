 ...
 *----------------------------------------------------------------------------
 *      Name:    usbreg.h
 *      Purpose: Hardware Layer Definitions for ST STR75x
 *----------------------------------------------------------------------------
...
#define USB_BASE_ADDR   0xFFFFA800  /* USB Registers Base Address */
#define USB_PMA_ADDR    0xFFFFA000  /* USB Packet Memory Area Address */
...
#define CNTR_DOVRM      0x4000      /* DMA Over/underrun Interrupt Mask */
...
#define CNTR_SZDPR      0x0080      /* Short or Zero-Length Received Data Packet Mask */
...
#define ISTR_DOVR       0x4000      /* DMA Over/underrun */
