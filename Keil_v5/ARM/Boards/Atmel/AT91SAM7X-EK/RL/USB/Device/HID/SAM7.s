...
;//     <i> DIV    = 5  (value: 5)
;//     <i> MUL    = 25 (value: 25)
;//     <i> OUT    = 80..160MHz (value: 0)
;//     <i> USBDIV = 2 (value: 1)
;//     <i> PRES   = Clock / 2 (value: 1)
;//     <i> Produce:
;//     <i> PLL Clock = 95.8464MHz
;//     <i> CPU Clock = 47.9232MHz
;//     <i> USB Clock = 47.9232MHz
;//     <o2.0..7>   DIV: PLL Divider <0-255>
;//                 <i> PLL Input is divided by DIV
...
;//                 <i> USB Clock is PLL divided by 2 or 4
...
Undef_Handler   B       Undef_Handler
                IF      :DEF:__RTX
                IMPORT  SWI_Handler            ; Part of RTL
                ELSE
