...
/*               adapted for the Atmel AT91SAM9263 Devices                    */
/*                                                                            */
/******************************************************************************/
...
#define SYS_CLOCK    16367660           // System Clock (in Hz)
...
int InitFlashController_HW (unsigned char bus_width, unsigned char adr_cycles, unsigned char page_type, unsigned long clk) {
  ...
  *AT91C_PMC_PCER  = (1 << AT91C_ID_PIOCDE);
  ...
  /* Setup pins                                                               */
  /* MISO  pin: int disable, not pull-up, alt func B select, enable alt func  */
  *AT91C_PIOA_IDR   = AT91C_PA0_SPI0_MISO; 
  *AT91C_PIOA_PPUDR = AT91C_PA0_SPI0_MISO; 
  *AT91C_PIOA_BSR   = AT91C_PA0_SPI0_MISO; 
  *AT91C_PIOA_PDR   = AT91C_PA0_SPI0_MISO; 
  /* MOSI  pin: int disable, not pull-up, alt func B select, enable alt func  */
  *AT91C_PIOA_IDR   = AT91C_PA1_SPI0_MOSI; 
  *AT91C_PIOA_PPUDR = AT91C_PA1_SPI0_MOSI; 
  *AT91C_PIOA_BSR   = AT91C_PA1_SPI0_MOSI; 
  *AT91C_PIOA_PDR   = AT91C_PA1_SPI0_MOSI; 
  /* SPCK  pin: int disable, not pull-up, alt func B select, enable alt func  */
  *AT91C_PIOA_IDR   = AT91C_PA2_SPI0_SPCK; 
  *AT91C_PIOA_PPUDR = AT91C_PA2_SPI0_SPCK; 
  *AT91C_PIOA_BSR   = AT91C_PA2_SPI0_SPCK; 
  *AT91C_PIOA_PDR   = AT91C_PA2_SPI0_SPCK; 
  /* NPCS0 pin: int disable, not pull-up, alt func B select, enable alt func  */
  *AT91C_PIOA_IDR   = AT91C_PA5_SPI0_NPCS0;
  *AT91C_PIOA_PPUDR = AT91C_PA5_SPI0_NPCS0;
  *AT91C_PIOA_BSR   = AT91C_PA5_SPI0_NPCS0;
  *AT91C_PIOA_PDR   = AT91C_PA5_SPI0_NPCS0;
...
int UnInit_HW (void) {
  ...
  *AT91C_PIOA_PER   = AT91C_PA5_SPI0_NPCS0;

  /* Disable clocks                                                           */
  *AT91C_PMC_PCDR   = (1 << AT91C_ID_PIOA);
  *AT91C_PMC_PCDR   = (1 << ID_SPI);

  /* Leave PIOCDE enabled as SDRAM is connected to it                         */
