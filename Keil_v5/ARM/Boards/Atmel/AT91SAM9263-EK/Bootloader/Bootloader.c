...
/******************************************************************************/
/*                                                                            */
/*  Bootloader.C 2-nd level bootloader for AT91SAM9263 Devices                */
/*                                                                            */
/******************************************************************************/
...
#define PB_ENABLE    *AT91C_PIOC_PPUER = AT91C_PIO_PC5      // Pushbutton PBP1
#define PB_PUSHED    !(*AT91C_PIOC_PDSR & AT91C_PIO_PC5)
...
int main (void) {
  ...
  InitFlashController_HW(0, 0, 0, 16367660);
