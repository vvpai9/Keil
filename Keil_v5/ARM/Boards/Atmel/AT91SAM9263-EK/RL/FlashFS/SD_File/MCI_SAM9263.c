 ...
 *----------------------------------------------------------------------------
 *      Name:    MCI_SAM9263.c
 *      Purpose: Multimedia Card Interface Driver for Atmel AT91SAM9263
 *      Rev.:    V4.54
 *----------------------------------------------------------------------------
...
#define __MCICLK  100024589
#define __CPUCLK  100024589
...
static BOOL Init (void) {
  ...
  pPMC->PMC_PCER   = (1 << AT91C_ID_PIOA) | (1 << AT91C_ID_PIOCDE) |
                     (1 << AT91C_ID_MCI1);
  ...
  pPIOA->PIO_PDR   = 
  pPIOA->PIO_ASR   =
  pPIOA->PIO_PPUER = AT91C_PA6_MCI1_CK | AT91C_PA7_MCI1_CDA | AT91C_PA8_MCI1_DA0 |
                     AT91C_PA9_MCI1_DA1| AT91C_PA10_MCI1_DA2| AT91C_PA11_MCI1_DA3;
  pPIOA->PIO_PPUDR = AT91C_PA6_MCI1_CK;

  /* Enable CD and WP pins. */
  pPIOE->PIO_ODR   = AT91C_PIO_PE18 | AT91C_PIO_PE19;
...
static BOOL UnInit (void) {
  ...
  /* Disable MCI pins. */
  pPIOA->PIO_PPUDR = AT91C_PA6_MCI1_CK | AT91C_PA7_MCI1_CDA | AT91C_PA8_MCI1_DA0 |
                     AT91C_PA9_MCI1_DA1| AT91C_PA10_MCI1_DA2| AT91C_PA11_MCI1_DA3;

  pMCI->MCI_CR     = AT91C_MCI_PWSEN | AT91C_MCI_MCIDIS;

  /* Power Down the MCI controller. */
  pPMC->PMC_PCDR   = (1 << AT91C_ID_MCI1);
  return (__TRUE);
}
...
static U32 CheckMedia (void) {
  ...
  if (!(pPIOE->PIO_PDSR & AT91C_PIO_PE18)) {
    /* Card is inserted (CD=0). */
    stat |= M_INSERTED;
  } 
  if (pPIOE->PIO_PDSR & AT91C_PIO_PE19) {
