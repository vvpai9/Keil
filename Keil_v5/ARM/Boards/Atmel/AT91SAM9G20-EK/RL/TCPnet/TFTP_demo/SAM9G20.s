;/*****************************************************************************/
;/* SAM9G20.S: Startup file for Atmel AT91SAM9G20 device series               */
;/*****************************************************************************/
...
; The SAM9G20.S code is executed after CPU Reset. This file may be 
...
;//     <o4.16..23> MULA: PLL A Multiplier <0-255>
;//                   <i> 0        - The PLL A is deactivated
;//                   <i> 1 .. 255 - The PLL A Clock frequency is the PLL a input 
...
;//     <o5.16..21> MULB: PLL B Multiplier <0-63>
;//                   <i> 0       - The PLL B is deactivated
;//                   <i> 1 .. 63 - The PLL B Clock frequency is the PLL a input 
;//                   <i>           frequency multiplied by MULB + 1
;//     <o5.28..29> USBDIV: Divider for USB Clock
;//                   <0=> USB Clk = PLLB
;//                   <1=> USB Clk = PLLB / 2
;//                   <2=> USB Clk = PLLB / 4
;//                   <3=> Reserved
...
;//                   <3=> Master Clock = Prescaler Output Clock / 6
;//     <o6.12>     PDIV: Processor Clock Division
;//                   <0=> Processor Clock = Prescaler Output Clock
;//                   <1=> Processor Clock = Prescaler Output Clock / 2
;//   </h>
;//
...
;//     <o9.0>      ICPLLA: Charge Pump Current
;//   </h>
;// </e>
PMC_SETUP       EQU     1
PMC_SCER_Val    EQU     0x00000001
PMC_PCER_Val    EQU     0x0020001C
CKGR_MOR_Val    EQU     0x00000701
CKGR_PLLAR_Val  EQU     0x202A0601
CKGR_PLLBR_Val  EQU     0x00000000
PMC_MCKR_Val    EQU     0x00000206
