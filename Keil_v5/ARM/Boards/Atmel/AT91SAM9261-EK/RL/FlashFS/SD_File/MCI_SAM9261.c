 ...
 *----------------------------------------------------------------------------
 *      Name:    MCI_SAM9261.c
 *      Purpose: Multimedia Card Interface Driver for Atmel AT91SAM9261
 *      Rev.:    V4.54
 *----------------------------------------------------------------------------
...
static BOOL Init (void) {
  ...
  pPIOA->PIO_PDR   = 
  pPIOA->PIO_BSR   =
  pPIOA->PIO_PPUER = AT91C_PA0_MCDA0 | AT91C_PA1_MCCDA | AT91C_PA2_MCCK |
                     AT91C_PA4_MCDA1 | AT91C_PA5_MCDA2 | AT91C_PA6_MCDA3;
  pPIOA->PIO_PPUDR = AT91C_PA2_MCCK;
...
static BOOL UnInit (void) {
  ...
  /* Disable MCI pins. */
  pPIOA->PIO_PPUDR = 
  pPIOA->PIO_ASR   = AT91C_PA0_MCDA0 | AT91C_PA1_MCCDA | AT91C_PA2_MCCK |
                     AT91C_PA4_MCDA1 | AT91C_PA5_MCDA2 | AT91C_PA6_MCDA3;
