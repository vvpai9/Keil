 ...
 *----------------------------------------------------------------------------
 *      Name:    SERIAL.C
 *      Purpose: Serial Input Output for Atmel AT91SAM9261
 *----------------------------------------------------------------------------
...
void init_serial (void) {
  ...
  /* Configure Debug Unit pins (PA9 and PA10). */
  AT91C_BASE_PMC->PMC_PCER   |= (1 << AT91C_ID_PIOA);
  AT91C_BASE_PIOA->PIO_IDR    = AT91C_PA9_DRXD | AT91C_PA10_DTXD;
  AT91C_BASE_PIOA->PIO_PPUDR  = AT91C_PA9_DRXD | AT91C_PA10_DTXD;
