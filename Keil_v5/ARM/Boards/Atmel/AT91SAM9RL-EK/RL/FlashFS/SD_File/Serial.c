 ...
 *----------------------------------------------------------------------------
 *      Name:    SERIAL.C
 *      Purpose: Serial Input Output for Atmel AT91SAM9RL
 *----------------------------------------------------------------------------
...
#define MCK_CLOCK         100000000           /* Master clock frequency      */
...
void init_serial (void) {
  ...
  /* Configure Debug Unit pins (PA21 and PA22). */
  AT91C_BASE_PMC->PMC_PCER   |= (1 << AT91C_ID_PIOA);
  AT91C_BASE_PIOA->PIO_IDR    = AT91C_PA21_DRXD | AT91C_PA22_DTXD;
  AT91C_BASE_PIOA->PIO_PPUDR  = AT91C_PA21_DRXD | AT91C_PA22_DTXD;
  AT91C_BASE_PIOA->PIO_ASR    = AT91C_PA21_DRXD | AT91C_PA22_DTXD;
  AT91C_BASE_PIOA->PIO_PDR    = AT91C_PA21_DRXD | AT91C_PA22_DTXD;
