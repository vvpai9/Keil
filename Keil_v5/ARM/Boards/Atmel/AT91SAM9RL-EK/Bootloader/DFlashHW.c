...
int InitFlashController_HW (unsigned char bus_width, unsigned char adr_cycles, unsigned char page_type, unsigned long clk) {
  ...
  *AT91C_PIOA_IDR   = AT91C_PA25_MISO; 
  *AT91C_PIOA_PPUDR = AT91C_PA25_MISO; 
  *AT91C_PIOA_ASR   = AT91C_PA25_MISO; 
  *AT91C_PIOA_PDR   = AT91C_PA25_MISO; 
  /* MOSI  pin: int disable, not pull-up, alt func A select, enable alt func  */
  *AT91C_PIOA_IDR   = AT91C_PA26_MOSI; 
  *AT91C_PIOA_PPUDR = AT91C_PA26_MOSI; 
  *AT91C_PIOA_ASR   = AT91C_PA26_MOSI; 
  *AT91C_PIOA_PDR   = AT91C_PA26_MOSI; 
  /* SPCK  pin: int disable, not pull-up, alt func A select, enable alt func  */
  *AT91C_PIOA_IDR   = AT91C_PA27_SPCK; 
  *AT91C_PIOA_PPUDR = AT91C_PA27_SPCK; 
  *AT91C_PIOA_ASR   = AT91C_PA27_SPCK; 
  *AT91C_PIOA_PDR   = AT91C_PA27_SPCK; 
  /* NPCS0 pin: int disable, not pull-up, alt func A select, enable alt func  */
  *AT91C_PIOA_IDR   = AT91C_PA28_NPCS0;
  *AT91C_PIOA_PPUDR = AT91C_PA28_NPCS0;
  *AT91C_PIOA_ASR   = AT91C_PA28_NPCS0;
  *AT91C_PIOA_PDR   = AT91C_PA28_NPCS0;
...
int UnInit_HW (void) {
  ...
  /* Disable SPI pins                                                         */
  *AT91C_PIOA_PER   = AT91C_PA25_MISO;
  *AT91C_PIOA_PER   = AT91C_PA26_MOSI;
  *AT91C_PIOA_PER   = AT91C_PA27_SPCK;
  *AT91C_PIOA_PER   = AT91C_PA28_NPCS0;
