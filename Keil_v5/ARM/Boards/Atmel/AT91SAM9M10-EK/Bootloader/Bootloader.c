...
/******************************************************************************/
/*                                                                            */
/*  Bootloader.C 2-nd level bootloader for AT91SAM9G45 Devices                */
/*                                                                            */
/******************************************************************************/
...
#define PB_ENABLE    *AT91C_PIOB_PPUER = AT91C_PIO_PB7     // Pushbutton PBP4
#define PB_PUSHED    !(*AT91C_PIOB_PDSR & AT91C_PIO_PB7)

#define DF_OFFSET    0x4200             // User Program offset in DataFlash
#define EXT_SDRAM    (0x70000000)       // Start address of external SDRAM
