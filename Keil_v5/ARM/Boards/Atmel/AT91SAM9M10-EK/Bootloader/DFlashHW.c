...
int UnInit_HW (void) {
  ...
  /* Disable SPI pins                                                         */
  *AT91C_PIOB_PER   = AT91C_PB0_SPI0_MISO;
  *AT91C_PIOB_PER   = AT91C_PB1_SPI0_MOSI;
  *AT91C_PIOB_PER   = AT91C_PB2_SPI0_SPCK;
#if   (CS_INDEX == 0)
  *AT91C_PIOB_PER   = AT91C_PB3_SPI0_NPCS0;
#elif (CS_INDEX == 1)
  *AT91C_PIOD_PER   = AT91C_PD24_SPI0_NPCS1;
#endif

  /* Disable clocks                                                           */
  *AT91C_PMC_PCDR   = (1 << AT91C_ID_PIOB);
