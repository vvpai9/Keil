;/*****************************************************************************/
;/* SAM9M10.s: Startup file for Atmel AT91SAM9M10 device series               */
;/*****************************************************************************/
...
;//     <o2.5>      PID5: Parallel IO Controller D/E Enable
;//     <o2.6>      PID6: True Random Number Generator Enable 
;//     <o2.7>      PID7: USART 0 Enable
;//     <o2.8>      PID8: USART 1 Enable
;//     <o2.9>      PID9: USART 2 Enable
;//     <o2.10>     PID10: USART 3 Enable
;//     <o2.11>     PID11: High Speed Multimedia Card Interface 0 Enable
;//     <o2.12>     PID12: Two-Wire Interface 0 Enable
;//     <o2.13>     PID13: Two-Wire Interface 1 Enable
;//     <o2.14>     PID14: Serial Peripheral Interface 0 Enable
;//     <o2.15>     PID15: Serial Peripheral Interface 1 Enable
;//     <o2.16>     PID16: Synchronous Serial Controller 0 Enable
;//     <o2.17>     PID17: Synchronous Serial Controller 1 Enable
;//     <o2.18>     PID18: Timer Counter 0,1,2,3,4,5 Enable
;//     <o2.19>     PID19: Pulse Width Modulation Controller Enable
;//     <o2.20>     PID20: Touch Screen ADC Controller Enable
;//     <o2.21>     PID21: DMA Controller Enable
;//     <o2.22>     PID22: USB Host High Speed Enable 
;//     <o2.23>     PID23: LCD Controller Enable
;//     <o2.24>     PID24: AC97 Controller Enable
;//     <o2.25>     PID25: Ethernet MAC
;//     <o2.26>     PID26: Image Sensor Interface Enable
;//     <o2.27>     PID27: USB Device High Speed Enable 
;//     <o2.29>     PID29: High Speed Multimedia Card Interface 1 Enable
;//     <o2.30>     PID30: Video Decoder Enable
...
;//                   <2=> PLL A Clock
;//                   <3=> UPLL  Clock
;//     <o5.2..4>   PRES: Master Clock Prescaler
;//                   <0=> Clock        <1=> Clock / 2
;//                   <2=> Clock / 4    <3=> Clock / 8
...
CKGR_MOR_Val    EQU     0x00004001
CKGR_PLLAR_Val  EQU     0x20C73F03
PMC_MCKR_Val    EQU     0x00001302
PMC_PCK0_Val    EQU     0x00000000
PMC_PCK1_Val    EQU     0x00000000
PMC_PLLICPR_Val EQU     0x00000000
...
MATRIX_BASE      EQU    0xFFFFEA00      ; Bus Matrix              Base Address
...
MATRIX_PRAS5_OFS EQU    0xA8            ; Priority A for Slave 2  Address Offset
MATRIX_PRAS6_OFS EQU    0xB0            ; Priority A for Slave 3  Address Offset
MATRIX_PRAS7_OFS EQU    0xB8            ; Priority A for Slave 4  Address Offset
...
MATRIX_PRBS5_OFS EQU    0xAC            ; Priority A for Slave 2  Address Offset
MATRIX_PRBS6_OFS EQU    0xB4            ; Priority A for Slave 3  Address Offset
MATRIX_PRBS7_OFS EQU    0xBC            ; Priority A for Slave 4  Address Offset
MATRIX_MRCR_OFS  EQU    0x100           ; Master Remap Control R  Address Offset
EBI_CSA_OFS      EQU    0x128           ; EBI Chip Select Assign  Address Offset
...
;//       <o9.0..2> ULBT: Undefined Length Burst Type 
;//                   <0=> Infinite Length Burst
;//                   <1=>  Single Access
;//                   <2=>   4-Beat Burst
;//                   <3=>   8-Beat Burst
...
;//       <o10.0..2> ULBT: Undefined Length Burst Type 
;//                   <0=> Infinite Length Burst
;//                   <1=>  Single Access
;//                   <2=>   4-Beat Burst
;//                   <3=>   8-Beat Burst
...
;//       <o11.0..2> ULBT: Undefined Length Burst Type 
;//                   <0=> Infinite Length Burst
;//                   <1=>  Single Access
;//                   <2=>   4-Beat Burst
;//                   <3=>   8-Beat Burst
...
;//       <o1.0..8>   SLOT_CYCLE: Maximum number of Allowed Cycles for a Burst
;//                   <i> When the SLOT_CYCLE limit is reached for a burst, it may be
;//                   <i> broken by another master trying to access this slave
...
;//       <o2.0..8>   SLOT_CYCLE: Maximum number of Allowed Cycles for a Burst
;//                   <i> When the SLOT_CYCLE limit is reached for a burst, it may be
;//                   <i> broken by another master trying to access this slave
...
;//       <o3.0..8>   SLOT_CYCLE: Maximum number of Allowed Cycles for a Burst
;//                   <i> When the SLOT_CYCLE limit is reached for a burst, it may be
;//                   <i> broken by another master trying to access this slave
...
;//       <o4.0..8>   SLOT_CYCLE: Maximum number of Allowed Cycles for a Burst
;//                   <i> When the SLOT_CYCLE limit is reached for a burst, it may be
;//                   <i> broken by another master trying to access this slave
...
;//       <o5.0..8>   SLOT_CYCLE: Maximum number of Allowed Cycles for a Burst
;//                   <i> When the SLOT_CYCLE limit is reached for a burst, it may be
;//                   <i> broken by another master trying to access this slave
...
;//       <o6.0..8>   SLOT_CYCLE: Maximum number of Allowed Cycles for a Burst
;//                   <i> When the SLOT_CYCLE limit is reached for a burst, it may be
;//                   <i> broken by another master trying to access this slave
...
;//       <o7.0..8>   SLOT_CYCLE: Maximum number of Allowed Cycles for a Burst
;//                   <i> When the SLOT_CYCLE limit is reached for a burst, it may be
;//                   <i> broken by another master trying to access this slave
...
;//       <o1.24..25> M6PR: Master 4 Priority
;//       <o1.28..29> M7PR: Master 5 Priority
;//     </h>
...
;//       <o2.24..25> M6PR: Master 4 Priority
;//       <o2.28..29> M7PR: Master 5 Priority
;//      </h>
...
;//       <o3.24..25> M6PR: Master 4 Priority
;//       <o3.28..29> M7PR: Master 5 Priority
;//     </h>
...
;//       <o4.24..25> M6PR: Master 4 Priority
;//       <o4.28..29> M7PR: Master 5 Priority
;//     </h>
;//     <h> Bus Matrix Priority Register A For Slaves 5 (MATRIX_PRAS5)
;//       <i> Fixed priority of Master x for access to the selected slave.
;//       <i> The higher the number, the higher the priority.
;//       <o5.0..1>   M0PR: Master 0 Priority
;//       <o5.4..5>   M1PR: Master 1 Priority
;//       <o5.8..9>   M2PR: Master 2 Priority
;//       <o5.12..13> M3PR: Master 3 Priority
;//       <o5.16..17> M4PR: Master 4 Priority
;//       <o5.20..21> M5PR: Master 5 Priority
;//       <o5.24..25> M6PR: Master 4 Priority
;//       <o5.28..29> M7PR: Master 5 Priority
;//     </h>
...
;//       <o6.24..25> M6PR: Master 4 Priority
;//       <o6.28..29> M7PR: Master 5 Priority
;//     </h>
;//     <h> Bus Matrix Priority Register A For Slaves 7 (MATRIX_PRAS7)
;//       <i> Fixed priority of Master x for access to the selected slave.
;//       <i> The higher the number, the higher the priority.
;//       <o7.0..1>   M0PR: Master 0 Priority
;//       <o7.4..5>   M1PR: Master 1 Priority
;//       <o7.8..9>   M2PR: Master 2 Priority
;//       <o7.12..13> M3PR: Master 3 Priority
;//       <o7.16..17> M4PR: Master 4 Priority
;//       <o7.20..21> M5PR: Master 5 Priority
;//       <o7.24..25> M6PR: Master 4 Priority
;//       <o7.28..29> M7PR: Master 5 Priority
;//     </h>
;//   </h>
...
;//       <o0.10..11>M11PR: Master 11 Priority
;//     </h>
;//     <h> Bus Matrix Priority Register B For Slaves 1 (MATRIX_PRBS1)
;//       <i> Fixed priority of Master x for access to the selected slave.
;//       <i> The higher the number, the higher the priority.
;//       <o1.0..1>   M8PR: Master  8 Priority
;//       <o1.4..5>   M9PR: Master  9 Priority
;//       <o1.8..9>  M10PR: Master 10 Priority
;//       <o1.10..11>M11PR: Master 11 Priority
;//     </h>
;//     <h> Bus Matrix Priority Register B For Slaves 2 (MATRIX_PRBS2)
;//       <i> Fixed priority of Master x for access to the selected slave.
;//       <i> The higher the number, the higher the priority.
;//       <o2.0..1>   M8PR: Master  8 Priority
;//       <o2.4..5>   M9PR: Master  9 Priority
;//       <o2.8..9>  M10PR: Master 10 Priority
;//       <o2.10..11>M11PR: Master 11 Priority
;//     </h>
;//     <h> Bus Matrix Priority Register B For Slaves 3 (MATRIX_PRBS3)
;//       <i> Fixed priority of Master x for access to the selected slave.
;//       <i> The higher the number, the higher the priority.
;//       <o3.0..1>   M8PR: Master  8 Priority
;//       <o3.4..5>   M9PR: Master  9 Priority
;//       <o3.8..9>  M10PR: Master 10 Priority
;//       <o3.10..11>M11PR: Master 11 Priority
;//     </h>
;//     <h> Bus Matrix Priority Register B For Slaves 4 (MATRIX_PRBS4)
;//       <i> Fixed priority of Master x for access to the selected slave.
;//       <i> The higher the number, the higher the priority.
;//       <o4.0..1>   M8PR: Master  8 Priority
;//       <o4.4..5>   M9PR: Master  9 Priority
;//       <o4.8..9>  M10PR: Master 10 Priority
;//       <o4.10..11>M11PR: Master 11 Priority
;//     </h>
;//     <h> Bus Matrix Priority Register B For Slaves 5 (MATRIX_PRBS5)
;//       <i> Fixed priority of Master x for access to the selected slave.
;//       <i> The higher the number, the higher the priority.
;//       <o5.0..1>   M8PR: Master  8 Priority
;//       <o5.4..5>   M9PR: Master  9 Priority
;//       <o5.8..9>  M10PR: Master 10 Priority
;//       <o5.10..11>M11PR: Master 11 Priority
;//     </h>
;//     <h> Bus Matrix Priority Register B For Slaves 6 (MATRIX_PRBS6)
;//       <i> Fixed priority of Master x for access to the selected slave.
;//       <i> The higher the number, the higher the priority.
;//       <o6.0..1>   M8PR: Master  8 Priority
;//       <o6.4..5>   M9PR: Master  9 Priority
;//       <o6.8..9>  M10PR: Master 10 Priority
;//       <o6.10..11>M11PR: Master 11 Priority
;//     </h>
;//     <h> Bus Matrix Priority Register B For Slaves 7 (MATRIX_PRBS7)
;//       <i> Fixed priority of Master x for access to the selected slave.
;//       <i> The higher the number, the higher the priority.
;//       <o7.0..1>   M8PR: Master  8 Priority
;//       <o7.4..5>   M9PR: Master  9 Priority
;//       <o7.8..9>  M10PR: Master 10 Priority
;//       <o7.10..11>M11PR: Master 11 Priority
;//     </h>
;//   </h>
...
;//     <o0.16..17> EBI_DRIVE: EBI I/O Drive Configuration
;//                   <0=> 1.8V powered Memories with Low Drive
;//                   <1=> 3.3V powered Memories with Low Drive
;//                   <2=> 1.8V powered Memories with High Drive
;//                   <3=> 3.3V powered Memories with High Drive
;//     <o0.18>     DDR_DRIVE: DDR2 Dedicated Port I/O Slew Rate Selection
;//                   <0=> Low Drive
;//                   <1=> High Drive
;//   </h>
...
SMC_BASE        EQU     0xFFFFE800      ; SMC                     Base Address
...
DDRSDRC_0_BASE    EQU     0xFFFFE600      ; DDRSDRC #0                          Base Address
DDRSDRC_1_BASE    EQU     0xFFFFE400      ; DDRSDRC #1                          Base Address
DDRSDRC_MR_OFS    EQU     0x00            ; DDRSDRC Mode Register               Address Offset
DDRSDRC_RTR_OFS   EQU     0x04            ; DDRSDRC Refresh Timer Register      Address Offset
DDRSDRC_CR_OFS    EQU     0x08            ; DDRSDRC Configuration Register      Address Offset
...
SDRAM_0_BASE      EQU     0x70000000      ; SDRAM  (DDRSDRC0 Chip Select)       Base Address
SDRAM_1_BASE      EQU     0x20000000      ; SDRAM  (DDRSDRC1 Chip Select)       Base Address
; Constants
...
;// <h> DDR/SDR SDRAM Controller (DDRSDRC)

;// <e> DDR/SDR SDRAM Controller 0 (DDRSDRC#0)
DDRSDRC_0_SETUP   EQU     1
...
;//   </h>
DDRSDRC_0_RTR_Val   EQU     0x00000411
...
;//     <o0.16>     EBISHARE: External Bus Interface is Shared
...
;//   </h>
DDRSDRC_0_CR_Val   EQU     0x0000003D
...
;//   </h>
DDRSDRC_0_T0PR_Val  EQU     0x21228226
...
;//   </h>
DDRSDRC_0_T1PR_Val  EQU     0x02c8100E
...
;//   </h>
DDRSDRC_0_T2PR_Val  EQU     0x00002072
...
;//   </h>
DDRSDRC_0_MD_Val  EQU     0x00000016
...
;//   </h>
DDRSDRC_0_HS_Val  EQU     0x00000004

;// </e> SDRAM Controller 0 (SDRAMC#0)


;// <e> DDR/SDR SDRAM Controller 1 (DDRSDRC#1)
DDRSDRC_1_SETUP   EQU     0

;//   <h> DDRSDRC Configuration Register (DDRSDRC_CR)
;//     <o0.0..12>  COUNT: DDRSDRC Refresh Timer Count <0-0xFFF>
;//                 <i> This 12-bit field is loaded into a timer which generates the refresh pulse
;//   </h>
DDRSDRC_1_RTR_Val   EQU     0x00000411
...
;//                 <1=> After an ACTIVE command in Bank X, BURST STOP command cannot be issued to another bank to stop current read access
;//   </h>
DDRSDRC_1_CR_Val   EQU     0x0000003D
...
;//                 <i> This field defines the delay between a Load mode register command and an active or refresh command in number of cycles
;//   </h>
DDRSDRC_1_T0PR_Val  EQU     0x21228226
...
;//                 <i> This field defines the delay between cke set high and a Valid Command in number of cycles 
;//   </h>
DDRSDRC_1_T1PR_Val  EQU     0x02c8100E
...
;//                 <i> This field defines the delay between Read Command and a Precharge command in number of cycle 
;//   </h>
DDRSDRC_1_T2PR_Val  EQU     0x00002072
...
;//                 <1=> Data bus width is 16 bits
;//   </h>
DDRSDRC_1_MD_Val  EQU     0x00000016
...
;//                 <1=> anticip read access is disabled
;//   </h>
DDRSDRC_1_HS_Val  EQU     0x00000004

;// </e> SDRAM Controller 1 (SDRAMC#1)
...
PLLA_Loop       LDR     R2, [R0, #PMC_SR_OFS]
                ...
                LDR     R1, =PMC_MCKR_Val
                LDR     R2, =(PMC_MCKR_Val:AND:0x0000131C)
...
; Setup DDR/SDR Controller 0 (DDRSDRC#0) ------------------------------------------

                ; Setup DDR/SDR Controller if enabled
                IF      (:LNOT::DEF:NO_SDRAM_INIT):LAND:(DDRSDRC_0_SETUP != 0)
...
Wait0_DDRSDC_13 SUBS    R4, R4, #1
                ...
                ; A minimum of 200 cycles
                MOV     R4, #1000
Wait0_DDRSDC_14 SUBS    R4, R4, #1
                BNE     Wait0_DDRSDC_14

                ; Write the refresh rate into the count field 
                LDR     R2, =DDRSDRC_0_RTR_Val
                STR     R2, [R0, #DDRSDRC_RTR_OFS]

                ; Read optimization" shall be un-selected 
                LDR     R2, =DDRSDRC_0_HS_Val
                STR     R2, [R0, #DDRSDRC_HS_OFS]

                ENDIF   ; of IF      (:LNOT::DEF:NO_SDRAM_INIT):LAND:(SDRAMC_0_SETUP != 0)


; Setup DDR/SDR Controller 1 (DDRSDRC#1) ------------------------------------------

                ; Setup DDR/SDR Controller if enabled
                IF      (:LNOT::DEF:NO_SDRAM_INIT):LAND:(DDRSDRC_1_SETUP != 0)
                ...
                ; Enable pins for SDRAM interfacing
                LDR     R0, =DDRSDRC_1_BASE
                LDR     R1, =SDRAM_1_BASE
                LDR     R3, =0x00000000

                ; Configure the DDR controller: 16-bit DDR
                LDR     R2, =DDRSDRC_1_MD_Val  
                STR     R2, [R0, #DDRSDRC_MD_OFS]
                ; Configure the DDR controller: 16-bit DDR
                LDR     R2, =DDRSDRC_1_CR_Val  
                STR     R2, [R0, #DDRSDRC_CR_OFS]
                ; Program the features of DDR2-SDRAM device into HDDRSDRC2_T0PR
                LDR     R2, =DDRSDRC_1_T0PR_Val  
                STR     R2, [R0, #DDRSDRC_T0PR_OFS]
                ; Program the features of DDR2-SDRAM device into HDDRSDRC2_T1PR
                LDR     R2, =DDRSDRC_1_T1PR_Val  
                STR     R2, [R0, #DDRSDRC_T1PR_OFS]
                ; Program the features of DDR2-SDRAM device into HDDRSDRC2_T2PR
                LDR     R2, =DDRSDRC_1_T2PR_Val  
                STR     R2, [R0, #DDRSDRC_T2PR_OFS]
...
Wait1_DDRSDC_13 SUBS    R4, R4, #1
                ...
                ; A minimum of 200 cycles
                MOV     R4, #1000
Wait1_DDRSDC_14 SUBS    R4, R4, #1
                BNE     Wait1_DDRSDC_14

                ; Write the refresh rate into the count field 
                LDR     R2, =DDRSDRC_1_RTR_Val
                STR     R2, [R0, #DDRSDRC_RTR_OFS]

                ; Read optimization" shall be un-selected 
                LDR     R2, =DDRSDRC_1_HS_Val
                STR     R2, [R0, #DDRSDRC_HS_OFS]

                ENDIF   ; of IF      (:LNOT::DEF:NO_SDRAM_INIT):LAND:(SDRAMC_1_SETUP != 0)
