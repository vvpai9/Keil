 ...
 *----------------------------------------------------------------------------
 *      Name:    RTX_CONFIG.C
 *      Purpose: Configuration of RTX Kernel for Atmel AT91SAM9G20
 *      Rev.:    V4.50
 *----------------------------------------------------------------------------
...
#include <RTL.h>
#include <AT91SAM9M10.H>                 /* AT91SAM9M10 definitions          */
...
//   <i> Default PIT: 6000000  (8.333333 MHz at 133.33 MHz MCLK and prescaler by 16)
//   <I> Default TCx: 3000000  (4.166667 MHz at 133.33 MHz MCLK and prescaler by 32)
#ifndef OS_CLOCK
 #define OS_CLOCK       8333333
#endif
...
#define OS_TRV          ((U32)(((double)OS_CLOCK*(double)OS_TICK)/1E6)-1)
...
#else
 #define OS_TVAL        (SYS->SYS_PITC_PIIR & 0x000FFFFF)/*  Timer Value     */
 #define OS_TOVF        (SYS->SYS_PITC_PISR & 1)         /*  Overflow Flag   */
 ...
 #define OS_TIACK()     CLR_IRQFLAG;                     /*  Interrupt Ack   */ \
                        ...
                        AIC->AIC_EOICR     = SYS->SYS_PITC_PIVR;
 #define OS_TINIT()     SYS->SYS_PITC_PIMR = OS_TRV |   /*  Initialization  */  \
