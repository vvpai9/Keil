...
Wait_1          SUBS    R6, R6, #1
                ...
                LDR     R4, =(NOP_CMD :OR: MPMCDynControl_Val)     ; Write NOP Cmd
...
Wait_2          SUBS    R6, R6, #1
                ...
                LDR     R4, =(PALL_CMD :OR: MPMCDynControl_Val)    ; Write Prchg All Cmd
                STR     R4, [R0, #MPMCDynControl_OFS]
...
Wait_3          SUBS    R6, R6, #1
                ...
                LDR     R4, =(MODE_CMD :OR: MPMCDynControl_Val)    ; Write MODE Cmd
                STR     R4, [R0, #MPMCDynControl_OFS]
                ...
                LDR     R4, =(NORMAL_CMD :OR: MPMCDynControl_Val)  ; Write NORMAL Cmd
                STR     R4, [R0, #MPMCDynControl_OFS]

                LDR     R4, =(MPMCDynConfig0_Val :OR: B_BIT)       ; Enable buffer
                STR     R4, [R0, #MPMCDynConfig0_OFS]
