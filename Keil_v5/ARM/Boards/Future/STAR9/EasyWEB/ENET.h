/*----------------------------------------------------------------------------
 *      STR912 Ethernet Definitions
 *----------------------------------------------------------------------------
 *      Name:    ENET.H
 *      Purpose: ST STR912 ENET hardware definitions
 *----------------------------------------------------------------------------
...
#define MYMAC_1         0x1EUL          /* our ethernet (MAC) address        */
#define MYMAC_2         0x30UL          /* (MUST be unique in LAN!)          */
#define MYMAC_3         0x6cUL
#define MYMAC_4         0xa2UL
#define MYMAC_5         0x45UL
#define MYMAC_6         0x5eUL
...
/* Locate buffers at the top of SRAM to compile under MDK eval version. */
#define TX_BUF_BASE         (0x4018000   - NUM_TX_BUF*ETH_BUF_SIZE)
#define RX_BUF_BASE         (TX_BUF_BASE - NUM_RX_BUF*ETH_BUF_SIZE)
#define TX_BUF(i)           (TX_BUF_BASE + ETH_BUF_SIZE*i)
#define RX_BUF(i)           (RX_BUF_BASE + ETH_BUF_SIZE*i)
...
#define DMA_RX_ERROR_MASK   (DMA_RX_FA      | DMA_RX_LEN_ERR | \
                             DMA_RX_CRC_ERR | DMA_RX_MII_ERR | \
                             DMA_RX_LCOLL   | DMA_RX_RUNT_FR | DMA_RX_OLEN_FR)
...
#define STE100P_DEF_ADR     0x8000      /* Default PHY device address        */
...
void           DummyReadFrame_ENET(unsigned short Size);
