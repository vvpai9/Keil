 ...
 *----------------------------------------------------------------------------
 *      Name:    RTX_CONFIG.C
 *      Purpose: Configuration of RTX Kernel for ADI ADuC712x
 *      Rev.:    V4.20
 *----------------------------------------------------------------------------
...
//   <i> Default: 2611200  (2.61MHz at 41.78MHz Core Clock and prescaler by 16)
#ifndef OS_CLOCK
 #define OS_CLOCK       2611200
#endif
 ...
 *---------------------------------------------------------------------------*/
 ...
 #define OS_TVAL        (OS_TRV - T0VAL0)               /*  Timer Value     */
...
//      LDRNE   PC,=__cpp(IRQy)                ; IRQy Function
        ...
        TST     R0,#0x0006                     ; Check OS IRQ Flag
