...
// MAIN_M3_REMAP_ADDR_OFFSET specifies the offset
// of the M3 remap in the R4 space flash address
// (not including offset imposed by memory map
// register)
#define MAIN_M3_REMAP_ADDR_OFFSET 0xFD000000
...
// MAIN_M3_REMAP_ADDR_MASK specifies the bit mask for
// determining all address bits exclusive of the offest
// imposed by the memory map register
#define MAIN_M3_REMAP_ADDR_MASK   0xFD000000
...
#define TIOTP_M3_REMAP_ADDR_OFFSET 0x00804000
#endif
...
#define MAX_FOSC_DELAY_DEFAULT 0x14
