...
/*               Spansion S29GLxxxA/N/P (16-bit bus)                          */
/*                                                                            */
/******************************************************************************/
...
int EraseChip (void) {
  ...
  M16(base_adr + (0x555 << ADR_SHIFT)) = 0xAA;
  M16(base_adr + (0x2AA << ADR_SHIFT)) = 0x55;
  M16(base_adr + (0x555 << ADR_SHIFT)) = 0x80;
  M16(base_adr + (0x555 << ADR_SHIFT)) = 0xAA;
  M16(base_adr + (0x2AA << ADR_SHIFT)) = 0x55;
  M16(base_adr + (0x555 << ADR_SHIFT)) = 0x10;
...
int ProgramPage (unsigned long adr, unsigned long sz, unsigned char *buf) {
  ...
  for (i = 0; i < ((sz+1)/2); i++)  {
    ...
    M16(base_adr + (0x555 << ADR_SHIFT)) = 0xAA;
    M16(base_adr + (0x2AA << ADR_SHIFT)) = 0x55;
    M16(base_adr + (0x555 << ADR_SHIFT)) = 0xA0;
